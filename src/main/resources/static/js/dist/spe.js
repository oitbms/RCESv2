(() => {
  ...
  // src/main/resources/static/js/spe.ts
  var Spe = class extends Base {
    constructor(itemsPerPage = Infinity, visibleRow = Infinity) {
      super($(`.table-body`), itemsPerPage, visibleRow, () => {
        this.displayPage("/api/spe/get-page-spe", void 0, (data) => this.fullData(data)).catch(console.error);
      });
      ...
      this.createFgisSpe = async (event) => {
        ...
        try {
          ...
          this.saveMassive = {};
          if (error.status === 404) {
            this.createNotification("\u0421\u0418 \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u043E \u0432 \u0440\u0435\u0435\u0441\u0442\u0440\u0435 \u0424\u0413\u0418\u0421", "warning" /* WARNING */);
            this.dialog.close("create-fgis-dialog");
            setTimeout(() => this.dialog.open("create-dialog"), 850);
          } else {
            this.createNotification("\u041E\u0448\u0438\u0431\u043A\u0430 \u043F\u0440\u0438 \u0441\u043E\u0437\u0434\u0430\u043D\u0438\u0438 SPE", "error" /* ERROR */);
          }
          button.prop("disabled", false);
        }
      };
      ...
      this.applyFilters = () => {
        ...
        $(".table-row").each((_, element) => {
          ...
          const statusMatch = this.currentStatus === "NONE" || (this.currentStatus === "NO_DOCUMENT" ? row.find('[data-document="false"]').length > 0 : row.find("[data-status]").attr("data-status") === this.currentStatus);
              ...
              this.createConfirmationDialog("\u041F\u043E\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u0435 \u0443\u0434\u0430\u043B\u0435\u043D\u0438\u0435 \u043E\u0431\u043E\u0440\u0443\u0434\u043E\u0432\u0430\u043D\u0438\u044F: {outNumber}", { outNumber: rowName }).then((confirmed) => {
                if (confirmed) {
                  this.deleteEntity(`/api/spe/delete/${rowId}`).then(() => {
                    this.deleteRow(rowId);
                    this.createNotification("\u041E\u0431\u043E\u0440\u0443\u0434\u043E\u0432\u0430\u043D\u0438\u0435 \u0443\u0441\u043F\u0435\u0448\u043D\u043E \u0443\u0434\u0430\u043B\u0435\u043D\u043E", "success" /* SUCCESS */);
                  }).catch(() => {
                    this.createNotification("\u0412\u043E\u0437\u043D\u0438\u043A\u043B\u0430 \u043E\u0448\u0438\u0431\u043A\u0430 \u043F\u0440\u0438 \u0443\u0434\u0430\u043B\u0435\u043D\u0438\u0438 \u043E\u0431\u043E\u0440\u0443\u0434\u043E\u0432\u0430\u043D\u0438\u044F", "error" /* ERROR */);
                  });
                }
              });
            }
      ...
      this.reports = [
        ...
        },
        {
          ...
          function: async (format) => {
            ...
            const groupByOrganization = Array.from(this.selectedRows).reduce((map, id) => {
            ...
            if (nonOrganization.length > 0) {
              this.createNotification("\u041E\u0431\u043E\u0440\u0443\u0434\u043E\u0432\u0430\u043D\u0438\u0435 \u0431\u0435\u0437 \u043E\u0440\u0433\u0430\u043D\u0438\u0437\u0430\u0446\u0438\u0438 \u043D\u0435 \u043F\u043E\u043F\u0430\u0432\u0448\u0438\u0435 \u0432 \u043E\u0442\u0447\u0435\u0442: " + nonOrganization.join(", "), "info" /* INFO */);
            }
    ...
    async workWithModal(event) {
      ...
      if (fieldName === "subDivision" || fieldName === "employee") {
        ...
        const renderRows = (items) => {
          const dialog2 = $(isEmployee ? "#employeeDialog" : "#subDivisionDialog");
          const rowContainer2 = dialog2.find(".dialog-content-rows");
          rowContainer2.empty();
          items.forEach((item) => {
            var _a;
            rowContainer2.append(
              `
        ...
        changeButton.off("click").on("click", () => {
          ...
          modalDiv.text(selected2.name);
          modalDiv.val(selected2.name);
          if (currentId) {
            this.saveMassive[currentId] = __spreadProps(__spreadValues({}, this.saveMassive[currentId]), { [fieldName]: selected2 });
          } else {
            this.saveMassive[fieldName] = selected2;
          }
          modalDiv.addClass("change-textarea");
    ...
    async openDocument(event) {
      ...
      if (spe.documentId !== null) {
        const document2 = await this.requestToApi(`/api/document/get-document/${spe.documentId}`, "GET");
        this.localCache.set("document", document2);
      ...
      $(document).off("change", ".organization-select").on("change", ".organization-select", (event2) => {
        const value = $(event2.currentTarget).val();
        this.saveMassive[currentSpeId] = __spreadProps(__spreadValues({}, this.saveMassive[currentSpeId]), { organization: value });
        this.saveSpe();
      });
    ...
    addFileToDocument(event, speId) {
      ...
      const url = spe.documentId ? `/api/document/add-file-to-document-and-get/${spe.documentId}` : `/api/spe/create-document/${spe.id}`;
    ...
    async employeeHandler(event) {
      ...
      try {
        ...
        this.createNotification("\u041E\u0448\u0438\u0431\u043A\u0430 \u043F\u0440\u0438 \u0437\u0430\u0433\u0440\u0443\u0437\u043A\u0435 \u0441\u043E\u0442\u0440\u0443\u0434\u043D\u0438\u043A\u043E\u0432", "error" /* ERROR */);
      }
    }
    async subDivisionHandler(event) {
      ...
      try {
        ...
        this.createNotification("\u041E\u0448\u0438\u0431\u043A\u0430 \u043F\u0440\u0438 \u0437\u0430\u0433\u0440\u0443\u0437\u043A\u0435 \u043F\u043E\u0434\u0440\u0430\u0437\u0434\u0435\u043B\u0435\u043D\u0438\u0439", "error" /* ERROR */);
      }
    }
  };
  $(document).ready(() => {
