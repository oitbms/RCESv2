(() => {
  ...
  // src/main/resources/static/js/ntd.ts
  var NtDocuments = class extends Base {
    constructor(itemsPerPage = Infinity, visibleRow = Infinity) {
      super($(`.table-body`), itemsPerPage, visibleRow, () => {
        this.displayPage("/api/ntd/get-page-ntd", void 0).catch(console.error);
      });
      ...
      this.openDocument = async (event) => {
        ...
        await this.openDocumentDialog(
          event,
          ntd.documentId,
          `/api/document/get-document/${ntd.documentId}`,
          ntd.documentId ? `/api/document/add-file-to-document` : `/api/ntd/create-document/${ntd.id}`,
          "/api/document/delete-file-from-document",
          (files) => {
        ...
        dialog.off("change", "#reloadFileInput").on("change", "#reloadFileInput", (reloadEvent) => {
          ...
          this.deleteEntity(`/api/document/delete-file-from-document/${fileId}`).then(() => {
            ...
            this.createNotification("\u0424\u0430\u0439\u043B \u0443\u0441\u043F\u0435\u0448\u043D\u043E \u043F\u0435\u0440\u0435\u0437\u0430\u0433\u0440\u0443\u0436\u0435\u043D", "success" /* SUCCESS */);
            ...
            this.createNotification("\u041F\u0440\u043E\u0438\u0437\u043E\u0448\u043B\u0430 \u043E\u0448\u0438\u0431\u043A\u0430 \u043F\u0440\u0438 \u043F\u0435\u0440\u0435\u0437\u0430\u0433\u0440\u0443\u0437\u043A\u0438 \u0434\u043E\u043A\u0443\u043C\u0435\u043D\u0442\u0430\u0446\u0438\u0438", "error" /* ERROR */);
            unlock();
          });
        });
      };
      this.openReferences = async (event) => {
        ...
        rowContainer.empty();
        const renderReference = (references2, checked) => {
        ...
        if (ntd.references.length > 0) {
          const references2 = await this.requestToApi(`/api/ntd/get-references?ids=${ntd.references}`, "GET");
          this.localCache.set("references", references2);
          renderReference(references2, true);
        }
        ...
        dialog.off("click", ".download-inn").on("click", ".download-inn", (e) => {
          ...
          if (documentId) {
            ...
            this.createNotification("\u0424\u0430\u0439\u043B \u043D\u0435 \u043F\u0440\u0438\u043A\u0440\u0435\u043F\u043B\u0435\u043D", "info" /* INFO */);
          }
        });
