...
const MARK_STATUSES = ['исправен', 'списан', 'на поверке', 'ремонт'];
// Организации
const ORGANIZATIONS = [
...
const SPE_MESSAGES = {
    ...
    SELECT_FROM_LIST: (field) => `Выберите ${field} из списка`,
    ORG_MISSING: (list) => `Оборудование без организации не попавшие в отчет: ${list.join(', ')}`,
};
// Селекторы элементов
const SPE_SELECTORS = {
...
//# sourceMappingURL=speConstants.js.map