...
const SGI_EMPLOYEE_ROLES = ['EVENT', 'CONTROL'];
const SGI_MESSAGES = {
    CREATE_SUCCESS: (num) => `Создано новое мероприятие под номером ${num}`,
    CREATE_SUB_SUCCESS: (num) => `Создана новая подзадача для мероприятия под номером ${num}`,
    ...
    AGREE_SUCCESS: (agreed) => agreed ? 'Мероприятие согласовано' : 'Согласование отменено',
    ...
    FILE_DELETE: 'Удалить',
    FILE_PRINT: 'Печать',
    SELECT_EMPLOYEE: (label) => `Выберите ${label} из списка`,
    EMPTY: '',
};
const SGI_SELECTORS = {
...
//# sourceMappingURL=sgiConstants.js.map