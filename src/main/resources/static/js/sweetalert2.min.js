...
!function (e, t) {
    ...
    function nn(e) {
        ...
        tn(s), t && (t.dataset.swal2Theme = s.theme), Fe(this, s), he.innerParams.set(this, s), Object.defineProperties(this, {
            params: {
    ...
    const kn = ["swal-title", "swal-html", "swal-footer"], Bn = e => {
        ...
        })()), V() || o.previousActiveElement || (o.previousActiveElement = document.activeElement), "function" == typeof e.didOpen) {
            const t = e.didOpen;
            setTimeout(() => t(s))
        }
