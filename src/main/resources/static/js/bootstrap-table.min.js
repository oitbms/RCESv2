...
!function (t, e) {
    ...
    function l(t, e) {
        return function (t) {
            ...
            if (null != n) {
                ...
                try {
                    if (o = (n = n.call(t)).next, 0 === e) ; else for (; !(l = (i = o.call(n)).done) && (s.push(i.value), s.length !== e); l = !0) ;
                } catch (t) {
                    c = !0, r = t
                } finally {
                    try {
    ...
    function R() {
        if (C) return T;
        C = 1;
        var t = I(), e = Function.prototype.call;
        return T = t ? e.bind(e) : function () {
            return e.apply(e, arguments)
        }, T
    }

    var $, E, j, N, D, F, L, _, V, B, H, M, U, z, q, W, G, K, Y, J, Q, X, Z, tt, et, nt, it, rt, ot, at, st, lt, ct, ut,
        ht, ft, dt, pt, gt, vt, bt, mt = {};
    ...
    function St() {
        if (D) return N;
        D = 1;
        var t = I(), e = Function.prototype, n = e.call, i = t && e.bind.bind(n, n);
    ...
    function xt() {
        if (L) return F;
        L = 1;
        var t = St(), e = t({}.toString), n = t("".slice);
        return F = function (t) {
            return n(e(t), 8, -1)
        }
    }
    ...
    function Ot() {
        if (V) return _;
        V = 1;
        var t = St(), e = k(), n = xt(), i = Object, r = t("".split);
        return _ = e(function () {
    ...
    function $t() {
        if (et) return tt;
        et = 1;
        var t = b().navigator, e = t && t.userAgent;
    ...
    function Et() {
        if (it) return nt;
        it = 1;
        var t, e, n = b(), i = $t(), r = n.process, o = n.Deno, a = r && r.versions || o && o.version, s = a && a.v8;
    ...
    function Dt() {
        if (ct) return lt;
        ct = 1;
        var t = It(), e = kt(), n = Rt(), i = Nt(), r = Object;
    ...
    var Bt, Ht, Mt, Ut, zt, qt, Wt, Gt, Kt, Yt, Jt, Qt, Xt, Zt, te, ee, ne, ie, re, oe, ae, se, le, ce,
        ue = {exports: {}};
    ...
    function fe() {
        if (Ut) return Mt;
        Ut = 1;
        var t = b(), e = Object.defineProperty;
    ...
    function de() {
        ...
        zt = 1;
        var t = he(), e = b(), n = fe(), i = "__core-js_shared__", r = ue.exports = e[i] || n(i, {});
    ...
    function ve() {
        if (Jt) return Yt;
        Jt = 1;
        var t = St(), e = ge(), n = t({}.hasOwnProperty);
        return Yt = Object.hasOwn || function (t, i) {
            return n(e(t), i)
        }
    }
    ...
    function be() {
        if (Xt) return Qt;
        Xt = 1;
        var t = St(), e = 0, n = Math.random(), i = t(1.1.toString);
    ...
    function me() {
        if (te) return Zt;
        te = 1;
        var t = b(), e = pe(), n = ve(), i = be(), r = jt(), o = Nt(), a = t.Symbol, s = e("wks"),
    ...
    function ye() {
        if (ne) return ee;
        ne = 1;
        var t = R(), e = At(), n = Dt(), i = _t(), r = Vt(), o = me(), a = TypeError, s = o("toPrimitive");
    ...
    function Se() {
        if (ae) return oe;
        ae = 1;
        var t = b(), e = At(), n = t.document, i = e(n) && e(n.createElement);
    ...
    function Oe() {
        if (ce) return P;
        ce = 1;
        var t = A(), e = R(), n = yt(), i = wt(), r = Pt(), o = we(), a = ve(), s = xe(),
    ...
    function Ne() {
        if (Ae) return $e;
        Ae = 1;
        var t = A(), e = xe(), n = Ee(), i = je(), r = we(), o = TypeError, a = Object.defineProperty,
            s = Object.getOwnPropertyDescriptor, l = "enumerable", c = "configurable", u = "writable";
        return $e.f = t ? n ? function (t, e, n) {
    ...
    var Fe, Le, _e, Ve, Be, He, Me, Ue, ze, qe, We, Ge, Ke, Ye, Je, Qe = {exports: {}};

    function Xe() {
        if (Le) return Fe;
        Le = 1;
        var t = A(), e = ve(), n = Function.prototype, i = t && Object.getOwnPropertyDescriptor, r = e(n, "name"),
            o = r && "something" === function () {
            }.name, a = r && (!t || t && i(n, "name").configurable);
        return Fe = {EXISTS: r, PROPER: o, CONFIGURABLE: a}
    }

    function Ze() {
        if (Ve) return _e;
        Ve = 1;
        var t = St(), e = kt(), n = de(), i = t(Function.toString);
    ...
    function nn() {
        ...
        var t, e, n, i = function () {
                if (He) return Be;
                He = 1;
                var t = b(), e = kt(), n = t.WeakMap;
                return Be = e(n) && /native code/.test(String(n))
            }(), r = b(), o = At(), a = De(), s = ve(), l = de(), c = tn(), u = en(), h = "Object already initialized",
            f = r.TypeError, d = r.WeakMap;
        if (i || l.state) {
        ...
        return We = {
            set: t, get: e, has: n, enforce: function (i) {
                return n(i) ? e(i) : t(i, {})
    ...
    function rn() {
        ...
        Ke = 1;
        var t = St(), e = k(), n = kt(), i = ve(), r = A(), o = Xe().CONFIGURABLE, a = Ze(), s = nn(), l = s.enforce,
            c = s.get, u = String, h = Object.defineProperty, f = t("".slice), d = t("".replace), p = t([].join),
            g = r && !e(function () {
                return 8 !== h(function () {
                }, "length", {value: 8}).length
            }), v = String(String).split("String"), b = Qe.exports = function (t, e, n) {
    ...
    function on() {
        if (Je) return Ye;
        Je = 1;
        var t = kt(), e = Ne(), n = rn(), i = fe();
        return Ye = function (r, o, a, s) {
            s || (s = {});
            var l = s.enumerable, c = void 0 !== s.name ? s.name : o;
            if (t(a) && n(a, c, s), s.global) l ? r[o] = a : i(o, a); else {
                try {
    ...
    function Cn() {
        if (hn) return un;
        hn = 1;
        var t = Tn(), e = Math.max, n = Math.min;
    ...
    function An() {
        if (bn) return vn;
        bn = 1;
        var t = Pt(), e = Cn(), n = kn(), i = function (i) {
            return function (r, o, a) {
                ...
                } else for (; l > u; u++) if ((i || u in s) && s[u] === o) return i || u || 0;
                return !i && -1
            }
        };
    ...
    function In() {
        if (yn) return mn;
        yn = 1;
        var t = St(), e = ve(), n = Pt(), i = An().indexOf, r = en(), o = t([].push);
    ...
    function $n() {
        if (xn) return On;
        xn = 1;
        var t = In(), e = Rn().concat("length", "prototype");
        return On.f = Object.getOwnPropertyNames || function (n) {
            return t(n, e)
        }, On
    }

    var En, jn, Nn, Dn, Fn, Ln, _n, Vn, Bn, Hn, Mn, Un, zn, qn, Wn, Gn, Kn, Yn, Jn, Qn, Xn, Zn, ti, ei, ni, ii, ri, oi,
        ai = {};
    ...
    function li() {
        if (Nn) return jn;
        Nn = 1;
        var t = It(), e = St(), n = $n(), i = si(), r = je(), o = e([].concat);
    ...
    function ci() {
        if (Fn) return Dn;
        Fn = 1;
        var t = ve(), e = li(), n = Oe(), i = Ne();
        return Dn = function (r, o, a) {
    ...
    function ui() {
        if (_n) return Ln;
        _n = 1;
        var t = k(), e = kt(), n = /#|\.prototype\./, i = function (n, i) {
            var l = o[r(n)];
    ...
    function hi() {
        if (Bn) return Vn;
        Bn = 1;
        var t = b(), e = Oe().f, n = De(), i = on(), r = fe(), o = ci(), a = ui();
        return Vn = function (s, l) {
            var c, u, h, f, d, p = s.target, g = s.global, v = s.stat;
            if (c = g ? t : v ? t[p] || r(p, {}) : t[p] && t[p].prototype) for (u in l) {
    ...
    function vi() {
        if (Jn) return Yn;
        Jn = 1;
        var t = gi(), e = kt(), n = xt(), i = me()("toStringTag"), r = Object, o = "Arguments" === n(function () {
            return arguments
        }());
        return Yn = t ? n : function (t) {
            var a, s, l;
    ...
    function bi() {
        if (Xn) return Qn;
        Xn = 1;
        var t = St(), e = k(), n = kt(), i = vi(), r = It(), o = Ze(), a = function () {
            }, s = r("Reflect", "construct"), l = /^\s*(?:class|function)\b/, c = t(l.exec), u = !l.test(a),
            h = function (t) {
                if (!n(t)) return !1;
                try {
                    return s(a, [], t), !0
    ...
    function mi() {
        if (ti) return Zn;
        ti = 1;
        var t = fi(), e = bi(), n = At(), i = me()("species"), r = Array;
    ...
    !function () {
        if (oi) return v;
        oi = 1;
        var t = hi(), e = k(), n = fi(), i = At(), r = ge(), o = kn(), a = di(), s = pi(), l = yi(), c = wi(), u = me(),
            h = Et(), f = u("isConcatSpreadable"), d = h >= 51 || !e(function () {
                var t = [];
        ...
        t({target: "Array", proto: !0, arity: 1, forced: !d || !c("concat")}, {
            concat: function (t) {
                var e, n, i, c, u, h = r(this), f = l(h, 0), d = 0;
                for (e = -1, i = arguments.length; e < i; e++) if (p(u = -1 === e ? h : arguments[e])) for (c = o(u), a(d + c), n = 0; n < c; n++, d++) n in u && s(f, d, u[n]); else a(d + 1), s(f, d++, u);
                return f.length = d, f
            }
        })
    }();
    var Si, xi, Oi, Ti, Ci, Pi, ki, Ai, Ii, Ri, $i = {}, Ei = {};
    ...
    function Ni() {
        ...
        Ci = 1;
        var t = It();
        return Ti = t("document", "documentElement")
    }

    function Di() {
        if (ki) return Pi;
        ki = 1;
        var t, e = je(), n = function () {
                if (Oi) return Ei;
                Oi = 1;
                var t = A(), e = Ee(), n = Ne(), i = je(), r = Pt(), o = ji();
                return Ei.f = t && !e ? Object.defineProperties : function (t, e) {
                    i(t);
                    for (var a, s = r(e), l = o(e), c = l.length, u = 0; c > u;) n.f(t, a = l[u++], s[a]);
                    return t
                }, Ei
            }(), i = Rn(), r = en(), o = Ni(), a = Se(), s = tn(), l = "prototype", c = "script", u = s("IE_PROTO"),
            h = function () {
            }, f = function (t) {
                return "<" + c + ">" + t + "</" + c + ">"
            }, d = function (t) {
        ...
        return r[u] = !0, Pi = Object.create || function (t, i) {
            var r;
    ...
    function Fi() {
        if (Ii) return Ai;
        Ii = 1;
        var t = me(), e = Di(), n = Ne().f, i = t("unscopables"), r = Array.prototype;
        return void 0 === r[i] && n(r, i, {configurable: !0, value: e(null)}), Ai = function (t) {
            r[i][t] = !0
        }
    }
    ...
    !function () {
        if (Ri) return $i;
        Ri = 1;
        var t = hi(), e = An().includes, n = k(), i = Fi();
        t({
            target: "Array", proto: !0, forced: n(function () {
    ...
    !function () {
        ...
        var t = hi(), e = function () {
            if (_i) return Li;
            _i = 1;
            var t = A(), e = St(), n = R(), i = k(), r = ji(), o = si(), a = yt(), s = ge(), l = Ot(),
                c = Object.assign, u = Object.defineProperty, h = e([].concat);
            return Li = !c || i(function () {
                if (t && 1 !== c({b: 1}, c(u({}, "a", {
                ...
                for (var c = s(e), u = arguments.length, f = 1, d = o.f, p = a.f; u > f;) for (var g, v = l(arguments[f++]), b = d ? h(r(v), d(v)) : r(v), m = b.length, y = 0; m > y;) g = b[y++], t && !n(p, v, g) || (c[g] = v[g]);
                return c
            } : c, Li
        }();
    ...
    var Ui, zi, qi, Wi, Gi, Ki, Yi, Ji, Qi, Xi, Zi, tr, er, nr = {};
    ...
    function or() {
        if (Ki) return Gi;
        Ki = 1;
        var t = k(), e = b().RegExp, n = t(function () {
            var t = e("a", "y");
        ...
        return Gi = {BROKEN_CARET: r, MISSED_STICKY: i, UNSUPPORTED_Y: n}
    }
    ...
    function lr() {
        if (tr) return Zi;
        tr = 1;
        var t, e, n = R(), i = St(), r = ir(), o = rr(), a = or(), s = pe(), l = Di(), c = nn().get, u = ar(), h = sr(),
            f = s("native-string-replace", String.prototype.replace), d = RegExp.prototype.exec, p = d,
            g = i("".charAt), v = i("".indexOf), b = i("".replace), m = i("".slice),
            y = (e = /b*/g, n(d, t = /a/, "a"), n(d, e, "a"), 0 !== t.lastIndex || 0 !== e.lastIndex),
            w = a.BROKEN_CARET, S = void 0 !== /()??/.exec("")[1];
        return (y || S || w || u || h) && (p = function (t) {
            var e, i, a, s, u, h, x, O = this, T = c(O), C = r(t), P = T.raw;
            if (P) return P.lastIndex = O.lastIndex, e = n(p, P, C), O.lastIndex = P.lastIndex, e;
            var k = T.groups, A = w && O.sticky, I = n(o, O), R = O.source, $ = 0, E = C;
            if (A && (I = b(I, "y", ""), -1 === v(I, "g") && (I += "g"), E = m(C, O.lastIndex), O.lastIndex > 0 && (!O.multiline || O.multiline && "\n" !== g(C, O.lastIndex - 1)) && (R = "(?: " + R + ")", E = " " + E, $++), i = new RegExp("^(?:" + R + ")", I)), S && (i = new RegExp("^" + R + "$(?!\\s)", I)), y && (a = O.lastIndex), s = n(d, A ? i : O, E), A ? s ? (s.input = m(s.input, $), s[0] = m(s[0], $), s.index = O.lastIndex, O.lastIndex += s[0].length) : O.lastIndex = 0 : y && s && (O.lastIndex = O.global ? s.index + s[0].length : a), S && s && s.length > 1 && n(f, s[0], i, function () {
                for (u = 1; u < arguments.length - 2; u++) void 0 === arguments[u] && (s[u] = void 0)
            }), s && k) for (s.groups = h = l(null), u = 0; u < k.length; u++) h[(x = k[u])[0]] = s[x[1]];
            return s
        }), Zi = p
    }
    ...
    function cr() {
        ...
        er = 1;
        var t = hi(), e = lr();
        return t({target: "RegExp", proto: !0, forced: /./.exec !== e}, {exec: e}), nr
    }

    cr();
    var ur, hr, fr, dr, pr, gr, vr, br = {};

    function mr() {
        if (hr) return ur;
        hr = 1;
        var t = At(), e = xt(), n = me()("match");
    ...
    !function () {
        if (vr) return br;
        vr = 1;
        var t = hi(), e = St(), n = yr(), i = Ct(), r = ir(), o = wr(), a = e("".indexOf);
        t({target: "String", proto: !0, forced: !o("includes")}, {
            includes: function (t) {
                return !!~a(r(i(this)), r(n(t)), arguments.length > 1 ? arguments[1] : void 0)
            }
        })
    }();
    var Sr, xr, Or, Tr, Cr, Pr, kr, Ar = {};
    ...
    function Rr() {
        if (Tr) return Or;
        Tr = 1;
        var t = Ir(), e = Lt(), n = I(), i = t(t.bind);
        return Or = function (t, r) {
    ...
    function $r() {
        if (Pr) return Cr;
        Pr = 1;
        var t = Rr(), e = St(), n = Ot(), i = ge(), r = kn(), o = yi(), a = e([].push), s = function (e) {
            var s = 1 === e, l = 2 === e, c = 3 === e, u = 4 === e, h = 6 === e, f = 7 === e, d = 5 === e || h;
            return function (p, g, v, b) {
                for (var m, y, w = i(p), S = n(w), x = r(S), O = t(g, v), T = 0, C = b || o, P = s ? C(p, x) : l || f ? C(p, 0) : void 0; x > T; T++) if ((d || T in S) && (y = O(m = S[T], T, w), e)) if (s) P[T] = y; else if (y) switch (e) {
                    case 3:
                        return !0;
                    case 5:
                        return m;
    ...
    !function () {
        if (kr) return Ar;
        kr = 1;
        var t = hi(), e = $r().find, n = Fi(), i = "find", r = !0;
    ...
    function Hr() {
        if (Dr) return Nr;
        Dr = 1;
        var t = ve(), e = kt(), n = ge(), i = tn(), r = Br(), o = i("IE_PROTO"), a = Object, s = a.prototype;
        return Nr = r ? a.getPrototypeOf : function (i) {
            var r = n(i);
            if (t(r, o)) return r[o];
            var l = r.constructor;
    ...
    !function () {
        ...
        var t = hi(), e = function () {
            if (Lr) return Fr;
            Lr = 1;
            var t = A(), e = k(), n = St(), i = Hr(), r = ji(), o = Pt(), a = n(yt().f), s = n([].push),
                l = t && e(function () {
            ...
            return Fr = {entries: c(!0), values: c(!1)}
        }().entries;
    ...
    !function () {
        if (zr) return qr;
        zr = 1;
        var t = gi(), e = on(), n = function () {
            if (Ur) return Mr;
            Ur = 1;
            var t = gi(), e = vi();
            return Mr = t ? {}.toString : function () {
                return "[object " + e(this) + "]"
            }
        }();
        t || e(Object.prototype, "toString", n, {unsafe: !0})
    }();
    var Wr, Gr, Kr, Yr, Jr, Qr, Xr, Zr, to, eo, no, io, ro, oo = {};

    function ao() {
        if (Gr) return Wr;
        Gr = 1, cr();
        var t = R(), e = on(), n = lr(), i = k(), r = me(), o = De(), a = r("species"), s = RegExp.prototype;
        return Wr = function (l, c, u, h) {
            var f = r(l), d = !i(function () {
                var t = {};
                return t[f] = function () {
                    return 7
                }, 7 !== ""[l](t)
            ...
            if (!d || !p || u) {
                var g = /./[f], v = c(f, ""[l], function (e, i, r, o, a) {
                    var l = i.exec;
                    return l === n || l === s.exec ? d && !a ? {done: !0, value: t(g, i, r, o)} : {
                        done: !0,
                        value: t(e, r, i, o)
                    } : {done: !1}
                });
    ...
    function lo() {
        if (Qr) return Jr;
        Qr = 1;
        var t = je(), e = so(), n = Tt(), i = me()("species");
        return Jr = function (r, o) {
    ...
    function co() {
        if (Zr) return Xr;
        Zr = 1;
        var t = St(), e = Tn(), n = ir(), i = Ct(), r = t("".charAt), o = t("".charCodeAt), a = t("".slice),
            s = function (t) {
                return function (s, l) {
                    var c, u, h = n(i(s)), f = e(l), d = h.length;
        ...
        return Xr = {codeAt: s(!1), charAt: s(!0)}
    }
    ...
    function ho() {
        if (io) return no;
        io = 1;
        var t = R(), e = je(), n = kt(), i = xt(), r = lr(), o = TypeError;
        return no = function (a, s) {
            var l = a.exec;
            if (n(l)) {
                var c = t(l, a, s);
                return null !== c && e(c), c
    ...
    !function () {
        if (ro) return oo;
        ro = 1;
        var t = R(), e = St(), n = ao(), i = je(), r = At(), o = Ct(), a = lo(), s = uo(), l = Pn(), c = ir(), u = _t(),
            h = ho(), f = or(), d = k(), p = f.UNSUPPORTED_Y, g = Math.min, v = e([].push), b = e("".slice),
            m = !d(function () {
                var t = /(?:)/, e = t.exec;
                t.exec = function () {
        ...
        n("split", function (e, n, f) {
            ...
            return [function (n, i) {
                ...
                var m = a(r, RegExp), w = r.unicode,
                    S = (r.ignoreCase ? "i" : "") + (r.multiline ? "m" : "") + (r.unicode ? "u" : "") + (p ? "g" : "y"),
                    x = new m(p ? "^(?:" + r.source + ")" : r, S), O = void 0 === e ? 4294967295 : e >>> 0;
                if (0 === O) return [];
                if (0 === o.length) return null === h(x, o) ? [o] : [];
                for (var T = 0, C = 0, P = []; C < o.length;) {
                    x.lastIndex = p ? 0 : C;
                    var k, A = h(x, p ? b(o, C) : o);
                    if (null === A || (k = g(l(x.lastIndex + (p ? C : 0)), o.length)) === T) C = s(o, C, w); else {
                        if (v(P, b(o, T, C)), P.length === O) return P;
                        for (var I = 1; I <= A.length - 1; I++) if (v(P, A[I]), P.length === O) return P;
                        C = T = k
                    }
                }
                return v(P, b(o, T)), P
    ...
    function xo() {
        if (vo) return go;
        vo = 1;
        var t = St(), e = Ct(), n = ir(), i = So(), r = t("".replace), o = RegExp("^[" + i + "]+"),
            a = RegExp("(^|[^" + i + "])[" + i + "]+$"), s = function (t) {
                return function (i) {
                    var s = n(e(i));
                    return 1 & t && (s = r(s, o, "")), 2 & t && (s = r(s, a, "$1")), s
                }
            };
        return go = {start: s(1), end: s(2), trim: s(3)}
    }

    !function () {
        if (yo) return wo;
        yo = 1;
        var t = hi(), e = xo().trim, n = function () {
            if (mo) return bo;
            mo = 1;
            var t = Xe().PROPER, e = k(), n = So();
        ...
        t({target: "String", proto: !0, forced: n("trim")}, {
            trim: function () {
                return e(this)
            }
        })
    }();
    var Oo, To, Co, Po, ko, Ao, Io, Ro, $o, Eo = {};

    function jo() {
        return To ? Oo : (To = 1, Oo = {
            CSSRuleList: 0,
    ...
    function No() {
        if (Po) return Co;
        Po = 1;
        var t = Se()("span").classList, e = t && t.constructor && t.constructor.prototype;
        return Co = e === Object.prototype ? void 0 : e
    }
    ...
    !function () {
        if ($o) return Eo;
        $o = 1;
        var t = b(), e = jo(), n = No(), i = function () {
            if (Ro) return Io;
            Ro = 1;
            var t = $r().forEach, e = Do()("forEach");
            return Io = e ? [].forEach : function (e) {
    ...
    !function () {
        ...
        Fo = 1;
        var t = hi(), e = $r().filter;
        t({target: "Array", proto: !0, forced: !wi()("filter")}, {
            filter: function (t) {
                return e(this, t, arguments.length > 1 ? arguments[1] : void 0)
            }
        })
    }();
    var _o, Vo, Bo, Ho, Mo, Uo, zo, qo, Wo, Go, Ko, Yo, Jo, Qo, Xo, Zo, ta, ea, na, ia, ra, oa, aa, sa = {};

    function la() {
        return Bo ? Vo : (Bo = 1, Vo = {})
    }

    function ca() {
        if (Mo) return Ho;
        Mo = 1;
        var t, e, n, i = k(), r = kt(), o = At(), a = Di(), s = Hr(), l = on(), c = me(), u = he(), h = c("iterator"),
            f = !1;
        return [].keys && ("next" in (n = [].keys()) ? (e = s(s(n))) !== Object.prototype && (t = e) : f = !0), !o(t) || i(function () {
            ...
            return this
        }), Ho = {IteratorPrototype: t, BUGGY_SAFARI_ITERATORS: f}
    }

    function ua() {
        if (zo) return Uo;
        zo = 1;
        var t = Ne().f, e = ve(), n = me()("toStringTag");
        return Uo = function (i, r, o) {
            i && !o && (i = i.prototype), i && !e(i, n) && t(i, n, {configurable: !0, value: r})
        }
    }
    ...
    function ha() {
        if (Wo) return qo;
        Wo = 1;
        var t = ca().IteratorPrototype, e = Di(), n = wt(), i = ua(), r = la(), o = function () {
            return this
        };
        return qo = function (a, s, l, c) {
            var u = s + " Iterator";
            return a.prototype = e(t, {next: n(+!c, l)}), i(a, u, !1, !0), r[u] = o, a
        }
    }
    ...
    function pa() {
        ...
        return Zo = Object.setPrototypeOf || ("__proto__" in {} ? function () {
            var r, o = !1, a = {};
            try {
    ...
    function ga() {
        if (na) return ea;
        na = 1;
        var t = hi(), e = R(), n = he(), i = Xe(), r = kt(), o = ha(), a = Hr(), s = pa(), l = ua(), c = De(), u = on(),
            h = me(), f = la(), d = ca(), p = i.PROPER, g = i.CONFIGURABLE, v = d.IteratorPrototype,
            b = d.BUGGY_SAFARI_ITERATORS, m = h("iterator"), y = "keys", w = "values", S = "entries", x = function () {
                return this
            };
        return ea = function (i, h, d, O, T, C, P) {
            o(d, h, O);
            var k, A, I, R = function (t) {
                    if (t === T && D) return D;
                ...
                }, $ = h + " Iterator", E = !1, j = i.prototype, N = j[m] || j["@@iterator"] || T && j[T],
                D = !b && N || R(T), F = "Array" === h && j.entries || N;
            if (F && (k = a(F.call(new i))) !== Object.prototype && k.next && (n || a(k) === v || (s ? s(k, v) : r(k[m]) || u(k, m, x)), l(k, $, !0, !0), n && (f[$] = x)), p && T === w && N && N.name !== w && (!n && g ? c(j, "name", w) : (E = !0, D = function () {
                return e(N, this)
            })), T) if (A = {
                values: R(w),
                keys: C ? D : R(y),
                entries: R(S)
            }, P) for (I in A) (b || E || !(I in j)) && u(j, I, A[I]); else t({
                target: h,
                proto: !0,
                forced: b || E
            }, A);
            return n && !P || j[m] === D || u(j, m, D, {name: T}), f[h] = D, A
        }
    }

    function va() {
        return ra ? ia : (ra = 1, ia = function (t, e) {
    ...
    function ba() {
        if (aa) return oa;
        aa = 1;
        var t = Pt(), e = Fi(), n = la(), i = nn(), r = Ne().f, o = ga(), a = va(), s = he(), l = A(),
            c = "Array Iterator", u = i.set, h = i.getterFor(c);
        oa = o(Array, "Array", function (e, n) {
    ...
    !function () {
        if (_o) return sa;
        _o = 1;
        var t = hi(), e = Ir(), n = An().indexOf, i = Do(), r = e([].indexOf), o = !!r && 1 / r([1], 1, -0) < 0;
        t({target: "Array", proto: !0, forced: o || !i("indexOf")}, {
            indexOf: function (t) {
    ...
    !function () {
        ...
        ma = 1;
        var t = hi(), e = $r().map;
        t({target: "Array", proto: !0, forced: !wi()("map")}, {
            map: function (t) {
                return e(this, t, arguments.length > 1 ? arguments[1] : void 0)
            }
        })
    ...
    !function () {
        if (xa) return Oa;
        xa = 1;
        var t = hi(), e = fi(), n = bi(), i = At(), r = Cn(), o = kn(), a = Pt(), s = pi(), l = me(), c = wi(),
            u = Ta(), h = c("slice"), f = l("species"), d = Array, p = Math.max;
        t({target: "Array", proto: !0, forced: !h}, {
            slice: function (t, l) {
                var c, h, g, v = a(this), b = o(v), m = r(t, b), y = r(void 0 === l ? b : l, b);
    ...
    var ka, Aa, Ia, Ra, $a, Ea, ja, Na, Da, Fa, La, _a, Va, Ba = {};

    function Ha() {
        if (Aa) return ka;
        Aa = 1;
        var t = kt(), e = At(), n = pa();
        return ka = function (i, r, o) {
            var a, s;
    ...
    function Ma() {
        if (Ea) return $a;
        Ea = 1;
        var t = R(), e = ve(), n = Rt(), i = function () {
            if (Ra) return Ia;
            Ra = 1;
            var t = b(), e = k(), n = t.RegExp, i = !e(function () {
                var t = !0;
                try {
                    n(".", "d")
                } catch (e) {
            ...
            return Ia = {correct: i}
        }(), r = rr(), o = RegExp.prototype;
        return $a = i.correct ? function (t) {
            return t.flags
        } : function (a) {
    ...
    function qa() {
        if (_a) return La;
        _a = 1;
        var t = It(), e = za(), n = me(), i = A(), r = n("species");
    ...
    !function () {
        if (Va) return Ba;
        Va = 1;
        var t = A(), e = b(), n = St(), i = ui(), r = Ha(), o = De(), a = Di(), s = $n().f, l = Rt(), c = mr(),
            u = ir(), h = Ma(), f = or(), d = Ua(), p = on(), g = k(), v = ve(), m = nn().enforce, y = qa(), w = me(),
            S = ar(), x = sr(), O = w("match"), T = e.RegExp, C = T.prototype, P = e.SyntaxError, I = n(C.exec),
            R = n("".charAt), $ = n("".replace), E = n("".indexOf), j = n("".slice),
            N = /^\?<[^\s\d!#%&*+<=>@^][^\s!#%&*+<=>@^]*>/, D = /a/g, F = /a/g, L = new T(D) !== D, _ = f.MISSED_STICKY,
            V = f.UNSUPPORTED_Y, B = t && (!L || _ || S || x || g(function () {
                return F[O] = !1, T(D) !== D || T(F) === F || "/a/i" !== String(T(D, "i"))
            }));
        if (i("RegExp", B)) {
            for (var H = function (t, e) {
                var n, i, s, f, d, p, g = l(C, this), b = c(t), y = void 0 === e, w = [], O = t;
                if (!g && b && y && t.constructor === H) return t;
                if ((b || l(C, t)) && (t = t.source, y && (e = h(O))), t = void 0 === t ? "" : u(t), e = void 0 === e ? "" : u(e), O = t, S && "dotAll" in D && (i = !!e && E(e, "s") > -1) && (e = $(e, /s/g, "")), n = e, _ && "sticky" in D && (s = !!e && E(e, "y") > -1) && V && (e = $(e, /y/g, "")), x && (f = function (t) {
                    for (var e, n = t.length, i = 0, r = "", o = [], s = a(null), l = !1, c = !1, u = 0, h = ""; i <= n; i++) {
                        if ("\\" === (e = R(t, i))) e += R(t, ++i); else if ("]" === e) l = !1; else if (!l) switch (!0) {
                            case"[" === e:
                                l = !0;
                                break;
                            case"(" === e:
                    ...
                    return [r, o]
                }(t), t = f[0], w = f[1]), d = r(T(t, e), g ? this : C, H), (i || s || w.length) && (p = m(d), i && (p.dotAll = !0, p.raw = H(function (t) {
                    for (var e, n = t.length, i = 0, r = "", o = !1; i <= n; i++) "\\" !== (e = R(t, i)) ? o || "." !== e ? ("[" === e ? o = !0 : "]" === e && (o = !1), r += e) : r += "[\\s\\S]" : r += e + R(t, ++i);
                    return r
                ...
                return d
            }, M = s(T), U = 0; M.length > U;) d(H, T, M[U++]);
            C.constructor = H, H.prototype = C, p(e, "RegExp", H, {constructor: !0})
        }
        y("RegExp")
    }();
    var Wa, Ga = {};
    !function () {
        if (Wa) return Ga;
        Wa = 1;
        var t = Xe().PROPER, e = on(), n = je(), i = ir(), r = k(), o = Ma(), a = "toString", s = RegExp.prototype,
            l = s[a], c = r(function () {
    ...
    !function () {
        if (Ka) return Ya;
        Ka = 1;
        var t, e = hi(), n = Ir(), i = Oe().f, r = Pn(), o = ir(), a = yr(), s = Ct(), l = wr(), c = he(),
            u = n("".slice), h = Math.min, f = l("endsWith");
        e({
            target: "String",
            proto: !0,
            ...
            endsWith: function (t) {
                var e = o(s(this));
                a(t);
                var n = arguments.length > 1 ? arguments[1] : void 0, i = e.length, l = void 0 === n ? i : h(r(n), i),
                    c = o(t);
    ...
    !function () {
        if (Ja) return Qa;
        Ja = 1;
        var t = co().charAt, e = ir(), n = nn(), i = ga(), r = va(), o = "String Iterator", a = n.set,
            s = n.getterFor(o);
    ...
    !function () {
        if (Xa) return Za;
        Xa = 1;
        var t = R(), e = St(), n = ao(), i = je(), r = At(), o = Pn(), a = ir(), s = Ct(), l = _t(), c = uo(), u = Ma(),
            h = ho(), f = e("".indexOf);
        n("match", function (e, n, d) {
            return [function (n) {
                var i = s(this), o = r(n) ? l(n, e) : void 0;
                return o ? t(o, n, i) : new RegExp(n)[e](a(i))
            }, function (t) {
                var e = i(this), r = a(t), s = d(n, e, r);
                if (s.done) return s.value;
                var l = a(u(e));
                if (-1 === f(l, "g")) return h(e, r);
                var p = -1 !== f(l, "u");
                e.lastIndex = 0;
                for (var g, v = [], b = 0; null !== (g = h(e, r));) {
                    var m = a(g[0]);
                    v[b] = m, "" === m && (e.lastIndex = c(r, o(e.lastIndex), p)), b++
                }
                return 0 === b ? null : v
            }]
        })
    }();
    var ts, es, ns, is, rs, os = {};

    function as() {
        if (is) return ns;
        is = 1;
        var t = St(), e = ge(), n = Math.floor, i = t("".charAt), r = t("".replace), o = t("".slice),
            a = /\$([$&'`]|\d{1,2}|<[^>]*>)/g, s = /\$([$&'`]|\d{1,2})/g;
        return ns = function (t, l, c, u, h, f) {
            var d = c + t.length, p = u.length, g = s;
    ...
    !function () {
        ...
        var t = function () {
                if (es) return ts;
                es = 1;
                var t = I(), e = Function.prototype, n = e.apply, i = e.call;
                return ts = "object" == typeof Reflect && Reflect.apply || (t ? i.bind(n) : function () {
                    return i.apply(n, arguments)
                }), ts
            }(), e = R(), n = St(), i = ao(), r = k(), o = je(), a = kt(), s = At(), l = Tn(), c = Pn(), u = ir(), h = Ct(),
            f = uo(), d = _t(), p = as(), g = Ma(), v = ho(), b = me()("replace"), m = Math.max, y = Math.min,
            w = n([].concat), S = n([].push), x = n("".indexOf), O = n("".slice), T = function (t) {
                return void 0 === t ? t : String(t)
            }, C = "$0" === "a".replace(/./, "$0"), P = !!/./[b] && "" === /./[b]("a", "$0");
        i("replace", function (n, i, r) {
            ...
            return [function (t, n) {
                ...
                var s = o(this), h = u(e);
                if ("string" == typeof n && -1 === x(n, C) && -1 === x(n, "$<")) {
                    var d = r(i, s, h, n);
                    if (d.done) return d.value
                }
                var b = a(n);
                b || (n = u(n));
                var P, k = u(g(s)), A = -1 !== x(k, "g");
                A && (P = -1 !== x(k, "u"), s.lastIndex = 0);
                for (var I, R = []; null !== (I = v(s, h)) && (S(R, I), A);) {
                    "" === u(I[0]) && (s.lastIndex = f(h, c(s.lastIndex), P))
                }
                for (var $ = "", E = 0, j = 0; j < R.length; j++) {
                    for (var N, D = u((I = R[j])[0]), F = m(y(l(I.index), h.length), 0), L = [], _ = 1; _ < I.length; _++) S(L, T(I[_]));
                    var V = I.groups;
                    if (b) {
                        var B = w([D], L, F, h);
                        void 0 !== V && S(B, V), N = u(t(n, void 0, B))
                    } else N = p(D, h, F, L, V, n);
                    F >= E && ($ += O(h, E, F) + N, E = F + D.length)
                }
                return $ + O(h, E)
            }]
        }, !!r(function () {
    ...
    function hs() {
        return ls ? ss : (ls = 1, ss = Object.is || function (t, e) {
    ...
    !function () {
        if (cs) return us;
        cs = 1;
        var t = R(), e = ao(), n = je(), i = At(), r = Ct(), o = hs(), a = ir(), s = _t(), l = ho();
        e("search", function (e, c, u) {
            return [function (n) {
                var o = r(this), l = i(n) ? s(n, e) : void 0;
                return l ? t(l, n, o) : new RegExp(n)[e](a(o))
            }, function (t) {
                var e = n(this), i = a(t), r = u(c, e, i);
    ...
    !function () {
        ...
        fs = 1;
        var t, e = hi(), n = Ir(), i = Oe().f, r = Pn(), o = ir(), a = yr(), s = Ct(), l = wr(), c = he(),
            u = n("".slice), h = Math.min, f = l("startsWith");
        e({
            target: "String",
            proto: !0,
    ...
    !function () {
        if (ps) return gs;
        ps = 1;
        var t = b(), e = jo(), n = No(), i = ba(), r = De(), o = ua(), a = me()("iterator"), s = i.values,
            l = function (t, n) {
                if (t) {
                    if (t[a] !== s) try {
                        r(t, a, s)
                    ...
                    if (o(t, n, !0), e[n]) for (var l in i) if (t[l] !== i[l]) try {
                        r(t, l, i[l])
                    } catch (e) {
                        t[l] = i[l]
                    }
    ...
    var vs, bs, ms, ys, ws, Ss, xs, Os, Ts, Cs, Ps, ks, As, Is, Rs, $s, Es, js, Ns, Ds, Fs = {};

    function Ls() {
        if (ms) return bs;
        ms = 1;
        var t = b(), e = A(), n = Object.getOwnPropertyDescriptor;
    ...
    function Vs() {
        if (Ts) return Os;
        Ts = 1;
        var t = Rt(), e = TypeError;
        return Os = function (n, i) {
            if (t(i, n)) return n;
    ...
    function Bs() {
        if (Ps) return Cs;
        Ps = 1;
        var t = vi(), e = _t(), n = Tt(), i = la(), r = me()("iterator");
        return Cs = function (o) {
    ...
    function Hs() {
        if (As) return ks;
        As = 1;
        var t = R(), e = Lt(), n = je(), i = Ft(), r = Bs(), o = TypeError;
    ...
    function Us() {
        if (Es) return $s;
        Es = 1;
        var t = Ta(), e = Math.floor, n = function (i, r) {
            var o = i.length;
            if (o < 8) for (var a, s, l = 1; l < o;) {
                for (s = l, a = i[l]; s && r(i[s - 1], a) > 0;) i[s] = i[--s];
                s !== l++ && (i[s] = a)
            } else for (var c = e(o / 2), u = n(t(i, 0, c), r), h = n(t(i, c), r), f = u.length, d = h.length, p = 0, g = 0; p < f || g < d;) i[p + g] = p < f && g < d ? r(u[p], h[g]) <= 0 ? u[p++] : h[g++] : p < f ? u[p++] : h[g++];
            return i
        };
        return $s = n
    }
    ...
    function zs() {
        ...
        Ns = 1, ba(), function () {
            if (vs) return Fs;
            vs = 1;
            var t = hi(), e = St(), n = Cn(), i = RangeError, r = String.fromCharCode, o = String.fromCodePoint,
                a = e([].join);
            t({target: "String", stat: !0, arity: 1, forced: !!o && 1 !== o.length}, {
        ...
        var t = hi(), e = b(), n = Ls(), i = It(), r = R(), o = St(), a = A(), s = function () {
                if (ws) return ys;
                ws = 1;
                var t = k(), e = me(), n = A(), i = he(), r = e("iterator");
                return ys = !t(function () {
                    var t = new URL("b?a=1&b=2&c=3", "https://a"), e = t.searchParams,
                        o = new URLSearchParams("a=1&a=2&b=3"), a = "";
            ...
            }(), l = on(), c = za(), u = _s(), h = ua(), f = ha(), d = nn(), p = Vs(), g = kt(), v = ve(), m = Rr(),
            y = vi(), w = je(), S = At(), x = ir(), O = Di(), T = wt(), C = Hs(), P = Bs(), I = va(), $ = Ms(),
            E = me(), j = Us(), N = E("iterator"), D = "URLSearchParams", F = D + "Iterator", L = d.set,
            _ = d.getterFor(D), V = d.getterFor(F), B = n("fetch"), H = n("Request"), M = n("Headers"),
            U = H && H.prototype, z = M && M.prototype, q = e.TypeError, W = e.encodeURIComponent,
            G = String.fromCharCode, K = i("String", "fromCodePoint"), Y = parseInt, J = o("".charAt), Q = o([].join),
            X = o([].push), Z = o("".replace), tt = o([].shift), et = o([].splice), nt = o("".split), it = o("".slice),
            rt = o(/./.exec), ot = /\+/g, at = /^[0-9a-f]+$/i, st = function (t, e) {
                var n = it(t, e, e + 2);
                ...
                for (var e = (t = Z(t, ot, " ")).length, n = "", i = 0; i < e;) {
                    ...
                    if ("%" === r) {
                        ...
                        if (0 === a) r = G(o); else {
                            ...
                            for (var s = [o], l = 1; l < a && !(++i + 3 > e || "%" !== J(t, i));) {
                                var c = st(t, i + 1);
                                if (c != c) {
                                    i += 3;
                                    break
                ...
                return n
            }, ht = /[!'()~]|%20/g, ft = {"!": "%21", "'": "%27", "(": "%28", ")": "%29", "~": "%7E", "%20": "+"},
            dt = function (t) {
                return ft[t]
            }, pt = function (t) {
                return Z(W(t), ht, dt)
            }, gt = f(function (t, e) {
                L(this, {type: F, target: _(t).entries, index: 0, kind: e})
            }, D, function () {
        ...
        vt.prototype = {
            type: D, bindURL: function (t) {
                this.url = t, this.update()
            }, parseObject: function (t) {
                var e, n, i, o, a, s, l, c = this.entries, u = P(t);
                if (u) for (n = (e = C(t, u)).next; !(i = r(n, e)).done;) {
                    if (a = (o = C(w(i.value))).next, (s = r(a, o)).done || (l = r(a, o)).done || !r(a, o).done) throw new q("Expected sequence with length 2");
        ...
        if (u(mt, {
            append: function (t, e) {
                var n = _(this);
                $(arguments.length, 2), X(n.entries, {key: x(t), value: x(e)}), a || this.length++, n.updateURL()
            }, delete: function (t) {
                for (var e = _(this), n = $(arguments.length, 1), i = e.entries, r = x(t), o = n < 2 ? void 0 : arguments[1], s = void 0 === o ? o : x(o), l = 0; l < i.length;) {
                    var c = i[l];
                    if (c.key !== r || void 0 !== s && c.value !== s) l++; else if (et(i, l, 1), void 0 !== s) break
                }
                ...
                for (var e = _(this).entries, n = $(arguments.length, 1), i = x(t), r = n < 2 ? void 0 : arguments[1], o = void 0 === r ? r : x(r), a = 0; a < e.length;) {
                    var s = e[a++];
                ...
                o || X(r, {key: s, value: l}), a || (this.size = r.length), n.updateURL()
            }, sort: function () {
                var t = _(this);
        ...
        }, {enumerable: !0}), l(mt, N, mt.entries, {name: "entries"}), l(mt, "toString", function () {
            return _(this).serialize()
        }, {enumerable: !0}), a && c(mt, "size", {
            get: function () {
                return _(this).entries.length
            }, configurable: !0, enumerable: !0
        }), h(bt, D), t({global: !0, constructor: !0, forced: !s}, {URLSearchParams: bt}), !s && g(M)) {
            var yt = o(z.has), xt = o(z.set), Ot = function (t) {
                if (S(t)) {
                    var e, n = t.body;
                    if (y(n) === D) return e = t.headers ? new M(t.headers) : new M, yt(e, "content-type") || xt(e, "content-type", "application/x-www-form-urlencoded;charset=UTF-8"), O(t, {
                        body: T(0, x(n)),
                        headers: T(0, e)
                    })
                }
            ...
            if (g(B) && t({global: !0, enumerable: !0, dontCallGetSet: !0, forced: !0}, {
                fetch: function (t) {
                ...
                U.constructor = Tt, Tt.prototype = U, t({
                    global: !0,
                    constructor: !0,
                    dontCallGetSet: !0,
                    forced: !0
        ...
        return js = {URLSearchParams: bt, getState: _}
    }
    ...
    var qs = {
        ...
        getBootstrapVersion: function () {
            ...
            for (var l = 0; l < t.length; l++) {
                ...
                try {
                    for (u.s(); !(c = u.n()).done;) {
                        var h = c.value, f = +h.rowspan || 1, d = +h.colspan || 1, p = i[l].indexOf(!1);
                        h.colspanIndex = p, 1 === d ? (h.fieldIndex = p, void 0 === h.field && (h.field = p)) : h.colspanGroup = +h.colspan;
                        for (var g = 0; g < f; g++) for (var v = 0; v < d; v++) i[l + g][p + v] = !0
                    }
                } catch (t) {
                    u.e(t)
                } finally {
            ...
            var i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : void 0, o = t;
            ...
            return n.each(function (n, a) {
                ...
                l._id = s.attr("id"), l._class = s.attr("class"), l._data = i.getRealDataAttr(s.data()), l._style = s.attr("style"), s.find(">td,>th").each(function (r, a) {
                    ...
                    for (var f = h; f < h + c; f++) for (var d = n; d < n + u; d++) o[d] || (o[d] = []), o[d][f] = !0;
                    var p = e[h].field;
            ...
            var n = t instanceof Element, i = n ? t : document.createElement("div"), o = new RegExp(e, "gim"),
                a = function (t, e) {
            ...
            var n = /\s*!important\s*$/i, i = function (t) {
                return "string" == typeof t && n.test(t) ? {value: t.replace(n, ""), priority: "important"} : {
                    value: t,
                    priority: ""
                }
            };
            if ("string" == typeof e) e.split(";").forEach(function (e) {
                var n = e.indexOf(":");
                if (n > 0) {
                    var r = e.substring(0, n).trim(), o = e.substring(n + 1).trim(), a = i(o), s = a.value,
                        l = a.priority;
                    t.style.setProperty(r, s, l)
                }
            ...
            } else if ("object" === h(e)) for (var c = 0, u = Object.entries(e); c < u.length; c++) {
                var f = l(u[c], 2), d = f[0], p = f[1], g = i(p), v = g.value, b = g.priority;
            ...
            for (var a = 0, s = Object.entries(r); a < s.length; a++) {
                var u = l(s[a], 2), h = u[0], f = u[1];
                if (void 0 !== f) if (["text", "innerText"].includes(h)) i.innerText = f; else if (["html", "innerHTML"].includes(h)) i.innerHTML = f; else if ("children" === h) o.push.apply(o, c(f)); else if ("class" === h) i.setAttribute("class", this.classToString(f)); else if ("style" === h) "string" == typeof f ? i.setAttribute("style", f) : this.parseStyle(i, f); else if (h.startsWith("@") || h.startsWith("on")) {
        ...
        buttonsClass: Ks.classes.buttons,
        buttonsOrder: ["paginationSwitch", "refresh", "toggle", "fullscreen", "columns"],
        buttonsPrefix: Ks.classes.buttonsPrefix,
    ...
    var Xs, Zs = {
        ...
        THEME: "bootstrap".concat(Gs),
        VERSION: "1.26.0"
    }, tl = {
        initConstants: function () {
            var e = this.options;
            this.constants = Zs.CONSTANTS, this.constants.theme = t.fn.bootstrapTable.theme, this.constants.dataToggle = this.constants.html.dataToggle || "data-toggle";
            var n = Ws.getIconsPrefix(t.fn.bootstrapTable.theme);
            "string" == typeof e.icons && (e.icons = Ws.calculateObjectValue(null, e.icons)), e.iconsPrefix = e.iconsPrefix || t.fn.bootstrapTable.defaults.iconsPrefix || n, e.icons = Object.assign(Ws.getIcons(Zs.ICONS, e.iconsPrefix), t.fn.bootstrapTable.defaults.icons, e.icons);
            var i = e.buttonsPrefix ? "".concat(e.buttonsPrefix, "-") : "";
            this.constants.buttonsClass = [e.buttonsPrefix, i + e.buttonsClass, Ws.sprintf("".concat(i, "%s"), e.iconSize)].join(" ").trim(), this.buttons = Ws.calculateObjectValue(this, e.buttons, [], {}), "object" !== h(this.buttons) && (this.buttons = {})
        }, initLocale: function () {
            if (this.options.locale) {
                ...
                for (var r = 0, o = Object.entries(i); r < o.length; r++) {
                    var a = l(o[r], 2), s = a[0], c = a[1],
                        u = this._defaultLocales.hasOwnProperty(s) ? this._defaultLocales[s] : Zs.DEFAULTS[s];
            ...
            var e = ["top", "both"].includes(this.options.paginationVAlign) ? '<div class="fixed-table-pagination clearfix"></div>' : "",
                ...
                i = Ws.calculateObjectValue(this.options, this.options.loadingTemplate, [this.options.formatLoadingMessage()]);
            ...
            }), Array.isArray(this.options.columns[0]) || (this.options.columns = [this.options.columns]), this.options.columns = Ws.extend(!0, [], n, this.options.columns), this.columns = [], this.fieldsColumnsIndex = [], !1 !== this.optionsColumnsChanged && Ws.setFieldIndex(this.options.columns), this.options.columns.forEach(function (t, n) {
                t.forEach(function (t, i) {
                    var r = Ws.extend({}, Zs.COLUMN_DEFAULTS, t, {passed: t});
                    void 0 !== r.fieldIndex && (e.columns[r.fieldIndex] = r, e.fieldsColumnsIndex[r.field] = r.fieldIndex), e.options.columns[n][i] = r
                })
            }), !this.options.data.length) {
                var i = Ws.trToData(this.columns, this.$el.find(">tbody>tr"));
                i.length && (this.options.data = i, this.fromHtml = !0)
            }
            this.options.pagination && "server" !== this.options.sidePagination || (this.footerData = Ws.trToData(this.columns, this.$el.find(">tfoot>tr"))), this.footerData && this.$el.find("tfoot").html("<tr></tr>"), !this.options.showFooter || this.options.cardView ? this.$tableFooter.hide() : this.$tableFooter.show()
        }
    }, el = {};
    !function () {
        if (Xs) return el;
        Xs = 1;
        var t = hi(), e = $r().findIndex, n = Fi(), i = "findIndex", r = !0;
        i in [] && Array(1)[i](function () {
            r = !1
        }), t({target: "Array", proto: !0, forced: r}, {
    ...
    !function () {
        if (al) return sl;
        al = 1;
        var t = hi(), e = ge(), n = Cn(), i = Tn(), r = kn(), o = function () {
            if (il) return nl;
            il = 1;
            var t = A(), e = fi(), n = TypeError, i = Object.getOwnPropertyDescriptor, r = t && !function () {
            ...
            return nl = r ? function (t, r) {
                if (e(t) && !i(t, "length").writable) throw new n("Cannot set read only .length");
                return t.length = r
            } : function (t, e) {
                return t.length = e
            }
        }(), a = di(), s = yi(), l = pi(), c = ll(), u = wi()("splice"), h = Math.max, f = Math.min;
        t({target: "Array", proto: !0, forced: !u}, {
            splice: function (t, u) {
                ...
                } else if (d > p) for (v = w - p; v > S; v--) m = v + d - 1, (b = v + p - 1) in y ? y[m] = y[b] : c(y, m);
                for (v = 0; v < d; v++) y[v + S] = arguments[v + 2];
                return o(y, w - p + d), g
            }
        })
    }();
    var cl, ul, hl, fl, dl, pl, gl, vl = function () {
        return i(function t(e) {
            ...
            key: "initDOM", value: function (t, e) {
                ...
                var n = this.initData(t, this.getNum(e)), i = n.rows.join(""), r = this.checkChanges("data", i),
                    o = this.checkChanges("top", n.topOffset), a = this.checkChanges("bottom", n.bottomOffset), s = [];
            ...
            key: "initData", value: function (t, e) {
                ...
                var n = Math.max((this.clusterRows - 50) * e, 0), i = n + this.clusterRows,
                    r = Math.max(n * this.itemHeight, 0), o = Math.max((t.length - i) * this.itemHeight, 0), a = [],
                    s = n;
                r < 1 && s++;
                for (var l = n; l < i; l++) t[l] && a.push(t[l]);
                return {start: n, end: i, topOffset: r, bottomOffset: o, rowsAbove: s, rows: a}
            }
        }, {
        ...
        initBodyEvent: function () {
            ...
            this.$body.find("> tr[data-index] > td").off("click dblclick").on("click dblclick", function (n) {
                ...
                if (!(i.find(".detail-icon").length || i.index() - Ws.getDetailViewIndexOffset(e.options) < 0)) {
                    var r = i.parent(), o = t(n.target).parents(".card-views").children(),
                        a = t(n.target).parents(".card-view"), s = r.data("index"), l = e.data[s],
                        c = e.options.cardView ? o.index(a) : i[0].cellIndex,
                        u = e.getVisibleFields()[c - Ws.getDetailViewIndexOffset(e.options)],
                        h = e.columns[e.fieldsColumnsIndex[u]], f = Ws.getItemField(l, u, e.options.escape, h.escape);
                    if (e.trigger("click" === n.type ? "click-cell" : "dbl-click-cell", u, f, l, i), e.trigger("click" === n.type ? "click-row" : "dbl-click-row", l, r, u), "click" === n.type && e.options.clickToSelect && h.clickToSelect && !Ws.calculateObjectValue(e.options, e.options.ignoreClickToSelectOn, [n.target])) {
                        var d = r.find(Ws.sprintf('[name="%s"]', e.options.selectItemName));
                        d.length && d[0].click()
                    }
            ...
            }), this.$selectItem = this.$body.find(Ws.sprintf('[name="%s"]', this.options.selectItemName)), this.$selectItem.off("click").on("click", function (n) {
                ...
                var r = n;
                if (r) {
                    if ("string" == typeof r && (r = Ws.calculateObjectValue(null, r)), !r) throw new Error("Unknown event in the scope: ".concat(n));
                    var o = e.header.fields[i], a = e.getVisibleFields().indexOf(o);
                    if (-1 !== a) {
                        a += Ws.getDetailViewIndexOffset(e.options);
                        var s = function (n) {
                            if (!r.hasOwnProperty(n)) return 1;
                            var i = r[n];
                            e.$body.find(">tr:not(.no-records-found)").each(function (r, s) {
                                var l = t(s), c = l.find(e.options.cardView ? ".card-views>.card-view" : ">td").eq(a),
                                    u = n.indexOf(" "), h = n.substring(0, u), f = n.substring(u + 1);
                                c.find(f).off(h).on(h, function (t) {
                                    var n = l.data("index"), r = e.data[n], a = r[o];
                                    i.apply(e, [t, a, r, n])
                                })
                            })
                        };
            ...
            var o = this;
            if (!(Ws.findIndex(this.hiddenRows, e) > -1)) {
                var a = Ws.calculateObjectValue(this.options, this.options.rowStyle, [e, n], {}),
                    u = Ws.calculateObjectValue(this.options, this.options.rowAttributes, [e, n], {}), f = {};
                if (e._data && !Ws.isEmptyObject(e._data)) for (var d = 0, p = Object.entries(e._data); d < p.length; d++) {
                ...
                var m = Ws.h("tr", s(s({
                    ...
                    "data-index": n,
                    "data-uniqueid": Ws.getItemField(e, this.options.uniqueId, !1),
                    "data-has-detail-view": this.options.detailView && Ws.calculateObjectValue(null, this.options.detailFilter, [n, e]) ? "true" : void 0
                }, u), f)), y = [], w = "";
                Ws.hasDetailViewIcon(this.options) && (w = Ws.h("td"), Ws.calculateObjectValue(null, this.options.detailFilter, [n, e]) && w.append(Ws.h("a", {
                    class: "detail-icon",
                    href: "#",
                    html: Ws.sprintf(this.constants.html.icon, this.options.iconsPrefix, this.options.icons.detailOpen)
                }))), w && "right" !== this.options.detailViewAlign && y.push(w);
                var S = this.header.fields.map(function (i, r) {
                    var a = o.columns[r], s = Ws.getItemField(e, i, o.options.escape, a.escape), u = "", h = {
                    ...
                    if ((!o.fromHtml && !o.autoMergeCells || void 0 !== s || a.checkbox || a.radio) && a.visible && (!o.options.cardView || a.cardVisible)) {
                        ...
                        var b = Ws.calculateObjectValue(o.header, o.header.cellStyles[r], [s, e, n, i], {});
                        if (b.classes && h.class.push(b.classes), b.css && h.style.push(b.css), u = Ws.calculateObjectValue(a, o.header.formatters[r], [s, e, n, i], s), a.checkbox || a.radio || (u = null == u ? o.options.undefinedText : u), a.searchable && o.searchText && o.options.searchHighlight && !a.checkbox && !a.radio) {
                            var m = o.searchText.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
                            if (o.options.searchAccentNeutralise && "string" == typeof u) {
                                var y = new RegExp("".concat(Ws.normalizeAccent(m)), "gmi").exec(Ws.normalizeAccent(u));
                                y && (m = u.substring(y.index, y.index + m.length))
                            }
                            var w = Ws.replaceSearchMark(u, m);
                            u = Ws.calculateObjectValue(a, a.searchHighlightFormatter, [u, o.searchText], w)
                        }
                        if (e["_".concat(i, "_data")] && !Ws.isEmptyObject(e["_".concat(i, "_data")])) for (var S = 0, x = Object.entries(e["_".concat(i, "_data")]); S < x.length; S++) {
                            var O = l(x[S], 2), T = O[0], C = O[1];
                            if ("index" === T) return;
                            h["data-".concat(T)] = C
                        }
                        if (a.checkbox || a.radio) {
                            var P = a.checkbox ? "checkbox" : "radio",
                                k = Ws.isObject(u) && u.hasOwnProperty("checked") ? u.checked : (!0 === u || s) && !1 !== u,
                                A = !a.checkboxEnabled || u && u.disabled,
                                I = o.header.formatters[r] && ("string" == typeof u || u instanceof Node || u instanceof t) ? Ws.htmlToNodes(u) : [];
                            return e[o.header.stateField] = !0 === u || !!s || u && u.checked, Ws.h(o.options.cardView ? "div" : "td", {
                                class: [o.options.cardView ? f : "bs-checkbox", a.class],
                                style: o.options.cardView ? void 0 : h.style
                            }, [Ws.h("label", {}, [Ws.h("input", {
                                "data-index": n,
                                name: o.options.selectItemName,
                                type: P,
                                value: e[o.options.idField],
                                checked: k ? "checked" : void 0,
                                disabled: A ? "disabled" : void 0
                            }), Ws.h("span")])].concat(c(I)))
                        }
                        if (o.options.cardView) {
                            if (o.options.smartDisplay && "" === u) return Ws.h("div", {class: f});
                            var R = o.options.showHeader ? Ws.h("span", {
                                class: ["card-view-title", b.classes],
                                style: h.style,
                                html: Ws.getFieldTitle(o.columns, i)
                            }) : "";
                            return Ws.h("div", {class: f}, [R, Ws.h("span", {
                                class: ["card-view-value", b.classes],
                                style: h.style
                            }, c(Ws.htmlToNodes(u)))])
                        }
                        return Ws.h("td", h, c(Ws.htmlToNodes(u)))
                    }
                }).filter(function (t) {
                    return t
                });
                return y.push.apply(y, c(S)), w && "right" === this.options.detailViewAlign && y.push(w), this.options.cardView ? m.append(Ws.h("td", {colspan: this.header.fields.length}, [Ws.h("div", {class: "card-views"}, y)])) : m.append.apply(m, y), m
            }
            ...
            var o = [], a = t(document.createDocumentFragment()), s = !1, l = [];
            this.autoMergeCells = Ws.checkAutoMergeCells(r.slice(this.pageFrom - 1, this.pageTo));
            for (var c = this.pageFrom - 1; c < this.pageTo; c++) {
                var u = r[c], h = this.initRow(u, c, r, a);
                if (s = s || !!h, h && h instanceof Node) {
                    var f = this.options.uniqueId, d = [h];
                    if (f && u.hasOwnProperty(f)) {
                        var p = u[f],
                            g = this.$body.find(Ws.sprintf('> tr[data-uniqueid="%s"][data-has-detail-view]', p)).next();
                        g.is("tr.detail-view") && (l.push(c), n && p === n || d.push(g[0]))
                    }
                    this.options.virtualScroll ? o.push(t("<div>").html(d).html()) : a.append(d)
                }
            }
            this.$el.removeAttr("role"), s ? this.options.virtualScroll ? (this.virtualScroll && this.virtualScroll.destroy(), this.virtualScroll = new vl({
                rows: o,
                fixedScroll: e,
            ...
            })) : this.$body.html(a) : (this.$body.html('<tr class="no-records-found">'.concat(Ws.sprintf('<td colspan="%s">%s</td>', this.getVisibleFields().length + Ws.getDetailViewIndexOffset(this.options), this.options.formatNoMatches()), "</tr>")), this.$el.attr("role", "presentation")), l.forEach(function (t) {
                i.expandRow(t)
            ...
            if (!this.options.cardView && this.options.showHeader && this.options.height ? (this.$tableHeader.show(), this.resetHeader(), e += this.$header.outerHeight(!0) + 1) : (this.$tableHeader.hide(), this.trigger("post-header")), !this.options.cardView && this.options.showFooter && (this.$tableFooter.show(), this.fitFooter(), this.options.height && (e += this.$tableFooter.outerHeight(!0))), this.$container.hasClass("fullscreen")) this.$tableContainer.css("height", ""), this.$tableContainer.css("width", ""); else if (this.options.height) {
                ...
                var i = this.$toolbar.outerHeight(!0), r = this.$pagination.outerHeight(!0),
                    o = this.options.height - i - r, a = this.$tableBody.find(">table"), s = a.outerHeight();
                if (this.$tableContainer.css("height", "".concat(o, "px")), this.$tableBorder && a.is(":visible")) {
                    var l = o - s - 2;
                    this.hasScrollBar && (l -= Ws.getScrollBarWidth()), this.$tableBorder.css("width", "".concat(a.outerWidth(), "px")), this.$tableBorder.css("height", "".concat(l, "px"))
                }
            }
            ...
            if (t.hasOwnProperty("index") ? n = this.getData()[t.index] : t.hasOwnProperty("uniqueId") && (n = this.getRowByUniqueId(t.uniqueId)), n) {
                var i = Ws.findIndex(this.hiddenRows, n);
            ...
            if (void 0 !== t && this.columns[t].visible !== e && (this.columns[t].visible = e, this.initHeader(), this.initSearch(), this.initPagination(), this.initBody(), this.options.showColumns)) {
                ...
                n && i.filter(Ws.sprintf('[value="%s"]', t)).prop("checked", e), i.filter(":checked").length <= this.options.minimumCountColumns && i.filter(":checked").prop("disabled", !0)
            }
            ...
            var n, i = this, o = r(this.columns.slice().reverse());
            try {
                for (o.s(); !(n = o.n()).done;) {
                    var a = n.value;
                    if (a.switchable) {
            ...
            var e, n, i = t.index, r = this.getVisibleFields().indexOf(t.field), o = +t.rowspan || 1,
                a = +t.colspan || 1, s = this.$body.find(">tr[data-index]");
            r += Ws.getDetailViewIndexOffset(this.options);
        ...
        updateSelected: function () {
            ...
            if (this.data.length && (this.$selectAll.prop("checked", !1), this.$selectItem.prop("checked", !1)), this.header.stateField) {
                ...
                try {
                    for (e.s(); !(t = e.n()).done;) {
                        t.value[this.header.stateField] = !1
                    }
                } catch (t) {
                    e.e(t)
                } finally {
            ...
            if (e.hasOwnProperty("field") && e.hasOwnProperty("values")) {
                ...
                this.data.forEach(function (r, o) {
                    ...
                    if (e.values.includes(r[e.field])) {
                        var a = n.$selectItem.filter(":enabled").filter(Ws.sprintf('[data-index="%s"]', o)),
    ...
    !function () {
        if (gl) return yl;
        gl = 1;
        var t = hi(), e = St(), n = Lt(), i = ge(), r = kn(), o = ll(), a = ir(), s = k(), l = Us(), c = Do(),
            u = function () {
                if (ul) return cl;
                ul = 1;
                var t = $t().match(/firefox\/(\d+)/i);
                return cl = !!t && +t[1]
            }(), h = function () {
                if (fl) return hl;
                fl = 1;
                var t = $t();
                return hl = /MSIE|Trident/.test(t)
            }(), f = Et(), d = function () {
                if (pl) return dl;
                pl = 1;
                var t = $t().match(/AppleWebKit\/(\d+)\./);
                return dl = !!t && +t[1]
            }(), p = [], g = e(p.sort), v = e(p.push), b = s(function () {
                p.sort(void 0)
            }), m = s(function () {
                p.sort(null)
            }), y = c("sort"), w = !s(function () {
                if (f) return f < 70;
                if (!(u && u > 3)) {
                    if (h) return !0;
                    if (d) return d < 603;
        ...
        t({target: "Array", proto: !0, forced: b || !m || !y || !w}, {
            sort: function (t) {
                void 0 !== t && n(t);
                var e = i(this);
    ...
    function kl() {
        ...
        Ol = 1;
        var t = St();
        return xl = t(1.1.valueOf)
    }

    !function () {
        if (Tl) return Cl;
        Tl = 1;
        var t = hi(), e = he(), n = A(), i = b(), r = Pl(), o = St(), a = ui(), s = ve(), l = Ha(), c = Rt(), u = Dt(),
            h = ye(), f = k(), d = $n().f, p = Oe().f, g = Ne().f, v = kl(), m = xo().trim, y = "Number", w = i[y],
            S = r[y], x = w.prototype, O = i.TypeError, T = o("".slice), C = o("".charCodeAt), P = function (t) {
                var e, n, i, r, o, a, s, l, c = h(t, "number");
                if (u(c)) throw new O("Cannot convert a Symbol value to a number");
                if ("string" == typeof c && c.length > 2) if (c = m(c), 43 === (e = C(c, 0)) || 45 === e) {
                    ...
                    for (a = (o = T(c, 2)).length, s = 0; s < a; s++) if ((l = C(o, s)) < 48 || l > r) return NaN;
                    return parseInt(o, i)
                }
                return +c
            }, I = a(y, !w(" 0o1") || !w("0b1") || w("+0x1")), R = function (t) {
        ...
        R.prototype = x, I && !e && (x.constructor = R), t({
            global: !0,
            constructor: !0,
            wrap: !0,
            forced: I
    ...
    var Al = {
        initServer: function (e, n) {
            var i = this, o = {}, a = this.header.fields.indexOf(this.options.sortName),
            ...
            if (this.header.sortNames[a] && (s.sortName = this.header.sortNames[a]), this.options.pagination && "server" === this.options.sidePagination && (s.pageSize = this.options.pageSize === this.options.formatAllRows() ? this.options.totalRows : this.options.pageSize, s.pageNumber = this.options.pageNumber), this.options.url || this.options.ajax) {
                ...
                if (Ws.isEmptyObject(this.filterColumnsPartial) || (s.filter = JSON.stringify(this.filterColumnsPartial, null)), Ws.extend(s, n || {}), !1 !== (o = Ws.calculateObjectValue(this.options, this.options.queryParams, [s], o))) {
                    e || this.showLoading();
                    var h = Ws.extend({}, Ws.calculateObjectValue(null, this.options.ajaxOptions), {
                        ...
                        success: function (t, n, r) {
                            var o = Ws.calculateObjectValue(i.options, i.options.responseHandler, [t, r], t);
                        ...
                        error: function (t) {
                            if (t && 0 === t.status && i._xhrAbort) i._xhrAbort = !1; else {
                                var n = [];
                    ...
                    return this.options.ajax ? Ws.calculateObjectValue(this, this.options.ajax, [h], null) : (this._xhr && 4 !== this._xhr.readyState && (this._xhrAbort = !0, this._xhr.abort()), this._xhr = t.ajax(h)), o
                }
            }
        }, initData: function (t, e) {
            "append" === e ? this.options.data = this.options.data.concat(t) : "prepend" === e ? this.options.data = [].concat(t).concat(this.options.data) : (t = t || Ws.deepCopy(this.options.data), this.options.data = Array.isArray(t) ? t : t[this.options.dataField]), this.data = c(this.options.data), this.options.sortReset && (this.unsortedData = c(this.data)), "server" !== this.options.sidePagination && this.initSort()
        }, initSort: function () {
            var t = this, e = this.options.sortName, n = "desc" === this.options.sortOrder ? -1 : 1,
            ...
            }), this.options.customSort ? Ws.calculateObjectValue(this.options, this.options.customSort, [this.options.sortName, this.options.sortOrder, this.data]) : this.data.sort(function (r, o) {
                t.header.sortNames[i] && (e = t.header.sortNames[i]);
                var a = Ws.getItemField(r, e, t.options.escape), s = Ws.getItemField(o, e, t.options.escape),
                    l = Ws.calculateObjectValue(t.header, t.header.sorters[i], [a, s, r, o]);
                return void 0 !== l ? t.options.sortStable && 0 === l ? n * (r._position - o._position) : n * l : Ws.sort(a, s, n, t.options, r._position, o._position)
            ...
            var n = e.type, i = e.currentTarget, r = "keypress" === n ? t(i) : t(i).parent(),
            ...
            if (!(this.searchText || this.options.customSearch || void 0 !== this.options.sortName || this.enableCustomSort) && Ws.isEmptyObject(this.filterColumns) && "function" != typeof this.options.filterOptions.filterAlgorithm && Ws.isEmptyObject(this.filterColumnsPartial) || t && t.unfiltered || (n = this.data), t && !t.includeHiddenRows) {
                var i = this.getHiddenRows();
                n = n.filter(function (t) {
                    return -1 === Ws.findIndex(i, t)
                })
            }
            return t && t.useCurrentPage && (n = n.slice(this.pageFrom - 1, this.pageTo)), t && t.formatted ? n.map(function (t) {
                for (var n = {}, i = 0, r = Object.entries(t); i < r.length; i++) {
                    ...
                    c && (n[a] = Ws.calculateObjectValue(c, e.header.formatters[c.fieldIndex], [s, t, t.index, c.field], s))
                }
                return n
            }) : n
            ...
            for (var e = 0, n = this.options.data.length - 1; n >= 0; n--) {
                var i = this.options.data[n], r = Ws.getItemField(i, t.field, this.options.escape, i.escape);
            ...
            try {
                for (n.s(); !(e = n.n()).done;) {
                    ...
                    if (i.hasOwnProperty("index") && i.hasOwnProperty("row")) {
                        var o = this.data[i.index], a = this.options.data.indexOf(o);
                        i.hasOwnProperty("replace") && i.replace ? (this.data[i.index] = i.row, this.options.data[a] = i.row) : (Ws.extend(this.data[i.index], i.row), Ws.extend(this.options.data[a], i.row))
                    }
                }
            } catch (t) {
                n.e(t)
            ...
            for (e = this.options.data.length - 1; e >= 0; e--) {
                ...
                var a = Ws.getItemField(n, i, this.options.escape, n.escape);
            ...
            var e, n = null, i = r(Array.isArray(t) ? t : [t]);
            try {
                for (i.s(); !(e = i.n()).done;) {
                    var o = e.value;
                    if (o.hasOwnProperty("id") && o.hasOwnProperty("row")) {
                        var a = this.options.data.indexOf(this.getRowByUniqueId(o.id));
                        -1 !== a && (o.hasOwnProperty("replace") && o.replace ? this.options.data[a] = o.row : Ws.extend(this.options.data[a], o.row), n = o.id)
                    }
                }
            } catch (t) {
                i.e(t)
            ...
            if (-1 !== n) {
                ...
                -1 !== r && (r += Ws.getDetailViewIndexOffset(this.options), this.$body.find(">tr[data-index=".concat(n, "]")).find(">td:eq(".concat(r, ")")).replaceWith(t(i).find(">td:eq(".concat(r, ")"))), this.initBodyEvent(), this.initFooter(), this.resetView(), this.updateSelected())
            }
            ...
            var e = this;
            (Array.isArray(t) ? t : [t]).forEach(function (t) {
                var n = t.id, i = t.field, r = t.value, o = e.getRowByUniqueId(n), a = e.data.indexOf(o),
                    s = e.options.data.indexOf(o);
        ...
        toggleDetailView: function (t, e) {
            this.$body.find(Ws.sprintf('> tr[data-index="%s"]', t)).next().is("tr.detail-view") ? this.collapseRow(t) : this.expandRow(t, e), this.resetView()
        }, expandRow: function (t, e) {
            var n = this.data[t], i = this.$body.find(Ws.sprintf('> tr[data-index="%s"][data-has-detail-view]', t));
            if (this.options.detailViewIcon && i.find("a.detail-icon").html(Ws.sprintf(this.constants.html.icon, this.options.iconsPrefix, this.options.icons.detailClose)), !i.next().is("tr.detail-view")) {
                i.after(Ws.sprintf('<tr class="detail-view"><td colspan="%s"></td></tr>', i.children("td").length));
                var r = i.next().find("td"), o = e || this.options.detailFormatter,
                    a = Ws.calculateObjectValue(this.options, o, [t, n, r], "");
            ...
            var e = this.data[t], n = this.$body.find(Ws.sprintf('> tr[data-index="%s"][data-has-detail-view]', t));
            n.next().is("tr.detail-view") && (this.options.detailViewIcon && n.find("a.detail-icon").html(Ws.sprintf(this.constants.html.icon, this.options.iconsPrefix, this.options.icons.detailOpen)), this.trigger("collapse-row", t, e, n.next()), n.next().remove())
        ...
        initHeader: function () {
            ...
            this.header = {
                ...
                cellStyles: [],
                searchables: []
            }, Ws.updateFieldGroup(this.options.columns, this.columns), this.options.columns.forEach(function (t, r) {
                var o = [];
                o.push("<tr".concat(Ws.sprintf(' class="%s"', e._headerTrClasses[r]), " ").concat(Ws.sprintf(' style="%s"', e._headerTrStyles[r]), ">"));
                var a = "";
                if (0 === r && Ws.hasDetailViewIcon(e.options)) {
                ...
                a && "right" !== e.options.detailViewAlign && o.push(a), t.forEach(function (t, i) {
                    var a = Ws.sprintf(' class="%s"', t.class), s = t.widthUnit, c = parseFloat(t.width),
                        u = t.halign ? t.halign : t.align, f = Ws.sprintf("text-align: %s; ", u),
                        d = Ws.sprintf("text-align: %s; ", t.align), p = Ws.sprintf("vertical-align: %s; ", t.valign);
                    if (p += Ws.sprintf("width: %s; ", !t.checkbox && !t.radio || c ? c ? c + s : void 0 : t.showSelectTitle ? void 0 : "36px"), void 0 !== t.fieldIndex || t.visible) {
                        var g = Ws.calculateObjectValue(null, e.options.headerStyle, [t]), v = [], b = [], m = "";
                        if (g && g.css) for (var y = 0, w = Object.entries(g.css); y < w.length; y++) {
                            var S = l(w[y], 2), x = S[0], O = S[1];
                            v.push("".concat(x, ": ").concat(O))
                        }
                        if (g && g.classes && (m = Ws.sprintf(' class="%s"', t.class ? [t.class, g.classes].join(" ") : g.classes)), void 0 !== t.fieldIndex) {
                        ...
                        if (Object.keys(t._data || {}).length > 0) for (var T = 0, C = Object.entries(t._data); T < C.length; T++) {
                            var P = l(C[T], 2), k = P[0], A = P[1];
                            b.push("data-".concat(k, "='").concat("object" === h(A) ? JSON.stringify(A) : A, "'"))
                        }
                        o.push("<th".concat(Ws.sprintf(' title="%s"', t.titleTooltip)), t.checkbox || t.radio ? Ws.sprintf(' class="bs-checkbox %s"', t.class || "") : m || a, Ws.sprintf(' style="%s"', f + p + v.join("; ") || void 0), Ws.sprintf(' rowspan="%s"', t.rowspan), Ws.sprintf(' colspan="%s"', t.colspan), Ws.sprintf(' scope="%s"', t.scope), Ws.sprintf(' data-field="%s"', t.field), 0 === i && r > 0 ? " data-not-first-th" : "", b.length > 0 ? b.join(" ") : "", ">"), o.push(Ws.sprintf('<div class="th-inner %s">', e.options.sortable && t.sortable ? "sortable".concat("center" === u ? " sortable-center" : "", " both") : ""));
                        var I = e.options.escape && e.options.escapeTitle ? Ws.escapeHTML(t.title) : t.title, R = I;
                        t.checkbox && (I = "", !e.options.singleSelect && e.options.checkboxHeader && (I = '<label><input name="btSelectAll" type="checkbox" /><span></span></label>'), e.header.stateField = t.field), t.radio && (I = "", e.header.stateField = t.field), !I && t.showSelectTitle && (I += R), o.push(I), o.push("</div>"), o.push('<div class="fht-cell"></div>'), o.push("</div>"), o.push("</th>")
                    }
            ...
            var r = Ws.getEventName("resize.bootstrap-table", this.$el.attr("id"));
            ...
            var t, e = [], n = r(this.header.fields);
            try {
                for (n.s(); !(t = n.n()).done;) {
                    var i = t.value, o = this.columns[this.fieldsColumnsIndex[i]];
            ...
            if (this.$el.is(":hidden")) this._setDelayTimeout("header", function () {
                ...
                var n = this.$tableBody.get(0),
                    i = this.hasScrollBar && n.scrollHeight > n.clientHeight + this.$header.outerHeight() ? Ws.getScrollBarWidth() : 0;
                ...
                var l = this.$el.find("caption"),
                    c = this.$tableHeader.css("margin-right", i).find("table").css("width", this.$el.outerWidth()).html("").attr("class", this.$el.attr("class"));
                l.length > 0 && c.append(l.clone(!0, !0)), c.append(this.$header_), this.$tableLoading.css("width", this.$el.outerWidth());
                ...
                u.length > 0 && (u.focus(), this.$header.find(".focus-temp").removeClass("focus-temp")), this.$header.find("th[data-field]").each(function (n, i) {
                    e.$header_.find(Ws.sprintf('th[data-field="%s"]', t(i).data("field"))).data(t(i).data())
                });
                ...
                d.find("> *").each(function (n, i) {
                    var r = t(i);
                    if (Ws.hasDetailViewIcon(e.options) && (0 === n && "right" !== e.options.detailViewAlign || n === p - 1 && "right" === e.options.detailViewAlign)) {
                        var o = f.filter(".detail"), a = o.innerWidth() - o.find(".fht-cell").width();
                        o.find(".fht-cell").width(r.innerWidth() - a)
                    } else {
                        var s = n - Ws.getDetailViewIndexOffset(e.options),
                            l = e.$header_.find(Ws.sprintf('th[data-field="%s"]', h[s]));
                        l.length > 1 && (l = t(f[r[0].cellIndex]));
                        var c = l.innerWidth() - l.find(".fht-cell").width();
                        l.find(".fht-cell").width(r.innerWidth() - c)
                    }
            ...
            if (this.options.showFooter && !this.options.cardView) {
                ...
                Ws.hasDetailViewIcon(this.options) && (n = Ws.h("th", {class: "detail"}, [Ws.h("div", {class: "th-inner"}), Ws.h("div", {class: "fht-cell"})])), n && "right" !== this.options.detailViewAlign && e.push(n);
                var i, o = r(this.columns);
                try {
                    for (o.s(); !(i = o.n()).done;) {
                        var a = i.value, l = this.footerData && this.footerData.length > 0;
                        if (a.visible && (!l || a.field in this.footerData[0])) {
                            if (this.options.cardView && !a.cardVisible) return;
                            var u = Ws.calculateObjectValue(null, a.footerStyle || this.options.footerStyle, [a]),
                                h = u && u.css || {}, f = l && this.footerData[0]["_".concat(a.field, "_colspan")] || 0,
                                d = l && this.footerData[0][a.field] || "";
                            d = Ws.calculateObjectValue(a, a.footerFormatter, [t, d], d), e.push(Ws.h("th", {
                                class: [a.class, u && u.classes],
                                style: s({"text-align": a.falign ? a.falign : a.align, "vertical-align": a.valign}, h),
                                colspan: f || void 0
                            }, [Ws.h("div", {class: "th-inner"}, c(Ws.htmlToNodes(d))), Ws.h("div", {class: "fht-cell"})]))
                        }
                    }
                } catch (t) {
                    o.e(t)
            ...
            if (this.$el.is(":hidden")) this._setDelayTimeout("footer", function () {
                ...
                o.find("> *").each(function (n, i) {
                    var o = t(i);
                    if (Ws.hasDetailViewIcon(e.options) && (0 === n && "left" === e.options.detailViewAlign || n === a - 1 && "right" === e.options.detailViewAlign)) {
                        var s = r.filter(".detail"), l = s.innerWidth() - s.find(".fht-cell").width();
                        s.find(".fht-cell").width(o.innerWidth() - l)
                    } else {
                        var c = r.eq(n), u = c.innerWidth() - c.find(".fht-cell").width();
            ...
            e.hasOwnProperty("field") && e.hasOwnProperty("title") && (this.columns[this.fieldsColumnsIndex[e.field]].title = this.options.escape && this.options.escapeTitle ? Ws.escapeHTML(e.title) : e.title, this.columns[this.fieldsColumnsIndex[e.field]].visible && (this.$header.find("th[data-field]").each(function (n, i) {
        ...
        initPagination: function () {
            ...
            if (e.pagination) {
                ...
                var n, i, r, o, a, s, l, c = [], u = !1, h = this.getData({includeHiddenRows: !1}), f = e.pageList;
                ...
                if (this.paginationParts.includes("pageSize")) {
                    ...
                    f.forEach(function (n, i) {
                        var r;
                        (!e.smartDisplay || 0 === i || f[i - 1] < e.totalRows || n === e.formatAllRows()) && (r = u ? n === e.formatAllRows() ? t.constants.classes.dropdownActive : "" : n === e.pageSize ? t.constants.classes.dropdownActive : "", g.push(Ws.sprintf(t.constants.html.pageDropdownItem, r, n)))
                ...
                if ((this.paginationParts.includes("pageInfo") || this.paginationParts.includes("pageInfoShort") || this.paginationParts.includes("pageSize")) && c.push("</div></div>"), this.paginationParts.includes("pageList")) {
                    c.push('<div class="'.concat(this.constants.classes.pull, "-").concat(e.paginationHAlign, ' pagination">'), Ws.sprintf(this.constants.html.pagination[0], Ws.sprintf(" pagination-%s", e.iconSize)), Ws.sprintf(this.constants.html.paginationItem, " page-pre", e.formatSRPaginationPreText(), e.paginationPreText)), this.totalPages < e.paginationSuccessivelySize ? (i = 1, r = this.totalPages) : r = (i = e.pageNumber - e.paginationPagesBySide) + 2 * e.paginationPagesBySide, e.pageNumber < e.paginationSuccessivelySize - 1 && (r = e.paginationSuccessivelySize), e.paginationSuccessivelySize > this.totalPages - i && (i = i - (e.paginationSuccessivelySize - (this.totalPages - i)) + 1), i < 1 && (i = 1), r > this.totalPages && (r = this.totalPages);
                    var v = Math.round(e.paginationPagesBySide / 2), b = function (n) {
                        var i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "";
                        return Ws.sprintf(t.constants.html.paginationItem, i + (n === e.pageNumber ? " ".concat(t.constants.classes.paginationActive) : ""), e.formatSRPaginationPageText(n), n)
                    };
                    if (i > 1) {
                        var m = e.paginationPagesBySide;
                        for (m >= i && (m = i - 1), n = 1; n <= m; n++) c.push(b(n));
                        i - 1 === m + 1 ? (n = i - 1, c.push(b(n))) : i - 1 > m && (i - 2 * e.paginationPagesBySide > e.paginationPagesBySide && e.paginationUseIntermediate ? (n = Math.round((i - v) / 2 + v), c.push(b(n, " page-intermediate"))) : c.push(Ws.sprintf(this.constants.html.paginationItem, " page-first-separator disabled", "", "...")))
                    }
                    for (n = i; n <= r; n++) c.push(b(n));
                    if (this.totalPages > r) {
                        var y = this.totalPages - (e.paginationPagesBySide - 1);
                        for (r >= y && (y = r + 1), r + 1 === y - 1 ? (n = r + 1, c.push(b(n))) : y > r + 1 && (this.totalPages - r > 2 * e.paginationPagesBySide && e.paginationUseIntermediate ? (n = Math.round((this.totalPages - v - r) / 2 + r), c.push(b(n, " page-intermediate"))) : c.push(Ws.sprintf(this.constants.html.paginationItem, " page-last-separator disabled", "", "..."))), n = y; n <= this.totalPages; n++) c.push(b(n))
                    }
                    c.push(Ws.sprintf(this.constants.html.paginationItem, " page-next", e.formatSRPaginationNextText(), e.paginationNextText)), c.push(this.constants.html.pagination[1], "</div>")
                }
            ...
            this.$toolbar.find('button[name="paginationSwitch"]').html("".concat(Ws.sprintf(this.constants.html.icon, this.options.iconsPrefix, t), " ").concat(e)), this.updatePagination(), this.trigger("toggle-pagination", this.options.pagination)
        }
    }, El = {
        initSearchText: function () {
            if (this.options.search && (this.searchText = "", "" !== this.options.searchText)) {
                var t = Ws.getSearchInput(this);
            ...
            if (this.filterOptions = this.filterOptions || this.options.filterOptions, "server" !== this.options.sidePagination) {
                if (this.options.customSearch) return this.data = Ws.calculateObjectValue(this.options, this.options.customSearch, [this.options.data, this.searchText, this.filterColumns]), this.options.sortReset && (this.unsortedData = c(this.data)), void this.initSort();
                var n = this.searchText && (this.fromHtml ? Ws.escapeHTML(this.searchText) : this.searchText),
                    i = n ? n.toLowerCase() : "", r = Ws.isEmptyObject(this.filterColumns) ? null : this.filterColumns;
                this.options.searchAccentNeutralise && (i = Ws.normalizeAccent(i)), "function" == typeof this.filterOptions.filterAlgorithm ? this.data = this.options.data.filter(function (t) {
                    ...
                    if ("and" === n) {
                        for (var i in r) if (Array.isArray(r[i]) && !r[i].includes(t[i]) || !Array.isArray(r[i]) && t[i] !== r[i]) return !1
                    } else if ("or" === n) {
                        var o = !1;
                ...
                this.data = i ? this.data.filter(function (r, a) {
                    for (var s = 0; s < e.header.fields.length; s++) if (e.header.searchables[s] && (!e.options.visibleSearch || -1 !== o.indexOf(e.header.fields[s]))) {
                        var l = Ws.isNumeric(e.header.fields[s]) ? parseInt(e.header.fields[s], 10) : e.header.fields[s],
                            c = e.columns[e.fieldsColumnsIndex[l]], u = void 0;
                        if ("string" != typeof l || r.hasOwnProperty(l)) u = r[l]; else {
                            u = r;
                        ...
                        if (e.options.searchAccentNeutralise && (u = Ws.normalizeAccent(u)), c && c.searchFormatter && (u = Ws.calculateObjectValue(c, e.header.formatters[s], [u, r, a, c.field], u), e.header.formatters[s] && "number" != typeof u && (u = t("<div>").html(u).text())), "string" == typeof u || "number" == typeof u) if (e.options.strictSearch) {
                            if ("".concat(u).toLowerCase() === i) return !0
                        } else if (e.options.regexSearch) {
                            if (Ws.regexCompare(u, n)) return !0
                        } else {
                            var d = /(?:(<=|=>|=<|>=|>|<)(?:\s+)?(-?\d+)?|(-?\d+)?(\s+)?(<=|=>|=<|>=|>|<))/gm.exec(e.searchText),
                                p = !1;
                            if (d) {
                                var g = d[1] || "".concat(d[5], "l"), v = d[2] || d[3], b = parseInt(u, 10),
                                    m = parseInt(v, 10);
                                switch (g) {
                                    case">":
                                    case"<l":
            ...
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = e.currentTarget,
                i = e.firedByInitSearchText, r = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
            if (void 0 !== n && t(n).length && r) {
                var o = t(n).val().trim();
                if (this.options.trimOnSearch && t(n).val() !== o && t(n).val(o), this.searchText === o) return;
                var a = Ws.getSearchInput(this), s = n instanceof jQuery ? n : t(n);
            ...
            var e = Ws.getSearchInput(this), n = t || "";
            e.val(n), this.searchText = n, this.options.searchText = n, this.onSearch({currentTarget: e}, !1)
        }, filterBy: function (t, e) {
            this.filterOptions = Ws.isEmptyObject(e) ? this.options.filterOptions : Ws.extend({}, this.options.filterOptions, e), this.filterColumns = Ws.isEmptyObject(t) ? {} : t, this.options.pageNumber = 1, this.initSearch(), this.updatePagination()
        }
    }, jl = {
        initToolbar: function () {
            var e, n = this, i = this.options, o = [], a = 0, s = 0;
            this.$toolbar.find(".bs-bars").children().length && t("body").append(t(i.toolbar)), this.$toolbar.html(""), "string" != typeof i.toolbar && "object" !== h(i.toolbar) || t(Ws.sprintf('<div class="bs-bars %s-%s"></div>', this.constants.classes.pull, i.toolbarAlign)).appendTo(this.$toolbar).append(t(i.toolbar)), o = ['<div class="'.concat(["columns", "columns-".concat(i.buttonsAlign), this.constants.classes.buttonsGroup, "".concat(this.constants.classes.pull, "-").concat(i.buttonsAlign)].join(" "), '">')], "string" == typeof i.buttonsOrder && (i.buttonsOrder = i.buttonsOrder.replace(/\[|\]| |'/g, "").split(",")), this.buttons = Object.assign(this.buttons, {
                ...
                columns: {
                    render: !1, html: function () {
                        var t = [];
                        if (t.push('<div class="keep-open '.concat(n.constants.classes.buttonsDropdown, '">\n            <button class="').concat(n.constants.buttonsClass, ' dropdown-toggle" type="button" ').concat(n.constants.dataToggle, '="dropdown"\n            aria-label="').concat(i.formatColumns(), '" ').concat(i.buttonsAttributeTitle, '="').concat(i.formatColumns(), '">\n            ').concat(i.showButtonIcons ? Ws.sprintf(n.constants.html.icon, i.iconsPrefix, i.icons.columns) : "", "\n            ").concat(i.showButtonText ? i.formatColumns() : "", "\n            ").concat(n.constants.html.dropdownCaret, "\n            </button>\n            ").concat(n.constants.html.toolbarDropdown[0])), i.showColumnsSearch && (t.push(Ws.sprintf(n.constants.html.toolbarDropdownItem, Ws.sprintf('<input type="text" class="%s" name="columnsSearch" placeholder="%s" autocomplete="off">', n.constants.classes.input, i.formatSearch()))), t.push(n.constants.html.toolbarDropdownSeparator)), i.showColumnsToggleAll) {
                            var e = n.getVisibleColumns().length === n.columns.filter(function (t) {
                                return !n.isSelectionColumn(t)
                            }).length;
                            t.push(Ws.sprintf(n.constants.html.toolbarDropdownItem, Ws.sprintf('<input type="checkbox" class="toggle-all" %s> <span>%s</span>', e ? 'checked="checked"' : "", i.formatColumnsToggleAll()))), t.push(n.constants.html.toolbarDropdownSeparator)
                        }
                        var r = 0;
                        return n.columns.forEach(function (t) {
                            ...
                            if (!n.isSelectionColumn(e) && (!i.cardView || e.cardVisible)) {
                                ...
                                e.switchable && (t.push(Ws.sprintf(n.constants.html.toolbarDropdownItem, Ws.sprintf('<input type="checkbox" data-field="%s" value="%s"%s%s> <span>%s</span>', e.field, o, a, l, e.switchableLabel || e.title))), s++)
                            }
            ...
            for (var c = {}, u = 0, f = Object.entries(this.buttons); u < f.length; u++) {
                var d = l(f[u], 2), p = d[0], g = d[1], v = void 0;
                if (g.hasOwnProperty("html")) "function" == typeof g.html ? v = g.html() : "string" == typeof g.html && (v = g.html); else {
                    ...
                    v += ">", i.showButtonIcons && g.hasOwnProperty("icon") && (v += "".concat(Ws.sprintf(this.constants.html.icon, i.iconsPrefix, g.icon), " ")), i.showButtonText && g.hasOwnProperty("text") && (v += g.text), v += "</button>"
                }
                c[p] = v;
                var T = "show".concat(p.charAt(0).toUpperCase()).concat(p.substring(1)), C = i[T];
                !(!g.hasOwnProperty("render") || g.hasOwnProperty("render") && g.render) || void 0 !== C && !0 !== C || (i[T] = !0), i.buttonsOrder.includes(p) || i.buttonsOrder.push(p)
            }
            var P, k = r(i.buttonsOrder);
            try {
                for (k.s(); !(P = k.n()).done;) {
                    var A = P.value;
            ...
            for (var I = function () {
                ...
                if (i.hasOwnProperty("event")) {
                    ...
                    for (var o = function () {
                        var t = l(s[a], 2), i = t[0], r = t[1], o = "string" == typeof r ? window[r] : r;
                        n.$toolbar.find('button[name="'.concat(e, '"]')).off(i).on(i, function () {
                            return o.call(n)
                        })
                    }, a = 0, s = Object.entries(i.event); a < s.length; a++) o()
                }
            }, R = 0, $ = Object.entries(this.buttons); R < $.length; R++) I();
            if (i.showColumns) {
                ...
                if (s <= i.minimumCountColumns && e.find("input").prop("disabled", !0), e.find("li, label").off("click").on("click", function (t) {
                    ...
                    var N = e.find('[name="columnsSearch"]'), D = e.find(".dropdown-item-marker");
                    N.on("keyup paste change", function (e) {
                        var n = e.currentTarget, i = t(n).val().toLowerCase();
                        D.show(), E.each(function (e, n) {
            ...
            if ((i.search || this.showSearchClearButton) && "string" != typeof i.searchSelector) {
                o = [];
                var L = Ws.sprintf(this.constants.html.searchButton, this.constants.buttonsClass, i.formatSearch(), i.showButtonIcons ? Ws.sprintf(this.constants.html.icon, i.iconsPrefix, i.icons.search) : "", i.showButtonText ? i.formatSearch() : ""),
                    _ = Ws.sprintf(this.constants.html.searchClearButton, this.constants.buttonsClass, i.formatClearSearch(), i.showButtonIcons ? Ws.sprintf(this.constants.html.icon, i.iconsPrefix, i.icons.clearSearch) : "", i.showButtonText ? i.formatClearSearch() : ""),
                ...
                if (i.showSearchButton || i.showSearchClearButton) {
                    ...
                    B = i.search ? Ws.sprintf(this.constants.html.inputGroup, V, H) : H
                }
                o.push(Ws.sprintf('\n        <div class="'.concat(this.constants.classes.pull, "-").concat(i.searchAlign, " search ").concat(this.constants.classes.inputGroup, '">\n          %s\n        </div>\n      '), B)), this.$toolbar.append(o.join(""));
                var M = Ws.getSearchInput(this);
                ...
                }), i.searchOnEnterKey && F(M)) : F(M), i.showSearchClearButton && this.$toolbar.find(".search button[name=clearSearch]").click(function () {
                    n.resetSearch()
                })
            } else "string" == typeof i.searchSelector && F(Ws.getSearchInput(this))
        }, refresh: function (t) {
            t && t.url && (this.options.url = t.url), t && t.pageNumber && (this.options.pageNumber = t.pageNumber), t && t.pageSize && (this.options.pageSize = t.pageSize), t && t.query && (this.options.url = Ws.addQueryToUrl(this.options.url, t.query)), this.trigger("refresh", this.initServer(t && t.silent))
        }, toggleView: function () {
            ...
            this.$toolbar.find('button[name="toggle"]').html("".concat(Ws.sprintf(this.constants.html.icon, this.options.iconsPrefix, t), " ").concat(this.options.showButtonText ? e : "")).attr("aria-label", e).attr(this.options.buttonsAttributeTitle, e), this.initBody(), this.trigger("toggle", this.options.cardView)
        ...
        return i(e, [{
            ...
            key: "getOptions", value: function () {
                var t = Ws.extend({}, this.options);
                return delete t.data, Ws.extend(!0, {}, t)
            }
        }, {
            key: "refreshOptions", value: function (t) {
                Ws.compareObjects(this.options, t, !0) || (this.optionsColumnsChanged = !!t.columns, this.options = Ws.extend(this.options, t), this.trigger("refresh-options", this.options), this.destroy(), this.init())
            }
        }, {
            key: "_setDelayTimeout", value: function (t, e, n) {
    ...
    return Object.assign(Nl.prototype, tl), Object.assign(Nl.prototype, Rl), Object.assign(Nl.prototype, Al), Object.assign(Nl.prototype, jl), Object.assign(Nl.prototype, El), Object.assign(Nl.prototype, $l), Object.assign(Nl.prototype, bl), Object.assign(Nl.prototype, ml), Object.assign(Nl.prototype, Il), Nl.VERSION = Zs.VERSION, Nl.DEFAULTS = Zs.DEFAULTS, Nl.LOCALES = Zs.LOCALES, Nl.COLUMN_DEFAULTS = Zs.COLUMN_DEFAULTS, Nl.METHODS = Zs.METHODS, Nl.EVENTS = Zs.EVENTS, t.BootstrapTable = Nl, t.fn.bootstrapTable = function (e) {
        ...
        return this.each(function (n, r) {
            ...
            if ("string" == typeof e) {
                var s;
                if (!Zs.METHODS.includes(e)) throw new Error("Unknown method: ".concat(e));
                if (!a) return;
                return o = (s = a)[e].apply(s, i), void ("destroy" === e && t(r).removeData("bootstrap.table"))
            }
            if (a) console.warn("You cannot initialize the table more than once!"); else {
                var l = Ws.extend(!0, {}, Nl.DEFAULTS, t(r).data(), "object" === h(e) && e);
                a = new t.BootstrapTable(r, l), t(r).data("bootstrap.table", a), a.init()
            }
        }), void 0 === o ? this : o
    }, t.fn.bootstrapTable.Constructor = Nl, t.fn.bootstrapTable.theme = Zs.THEME, t.fn.bootstrapTable.VERSION = Zs.VERSION, t.fn.bootstrapTable.icons = Zs.ICONS, t.fn.bootstrapTable.defaults = Nl.DEFAULTS, t.fn.bootstrapTable.columnDefaults = Nl.COLUMN_DEFAULTS, t.fn.bootstrapTable.events = Nl.EVENTS, t.fn.bootstrapTable.locales = Nl.LOCALES, t.fn.bootstrapTable.methods = Nl.METHODS, t.fn.bootstrapTable.utils = Ws, t(function () {
