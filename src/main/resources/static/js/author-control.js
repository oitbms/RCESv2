...
function createAuthorDivision() {
    const subDivisionValue = document.getElementById('subDivisionId').value;
    let subDivision;
...
function openAnnullingModal(authorControlId) {
    const createDate = {
        id: authorControlId,
        statusAuthor: "CANCELLED"
    };
...
function printReport() {
    ...
    const url = `/api/report/print/author-control?format=DOC&id=${authorControlId}`;
