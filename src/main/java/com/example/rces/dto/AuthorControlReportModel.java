...
public class AuthorControlReportModel {
    ...
    public AuthorControlReportModel(AuthorControl authorControl) {
        ...
        this.subDivision = authorControl.getSubDivision() != null ? authorControl.getSubDivision().getName() : "Отсутствует";
        this.plan = authorControl.getTypeAuthor().getName();
    ...
    public static class Table {
        ...
        public Table(AuthorControlDeviation deviation) {
            ...
            this.subDivision = deviation.getSubDivision() != null ? deviation.getSubDivision().getName() : "Отсутствует";
            this.periodRemoval = deviation.getPeriodRemoval() != null ? deviation.getPeriodRemoval().format(DateTimeFormatter.ofPattern("dd.MM.yyyy")) : "-";
            this.dateRemoval = deviation.getDateRemoval()  != null ?  deviation.getDateRemoval().format(DateTimeFormatter.ofPattern("dd.MM.yyyy")) : "-";
        }
        ...
        public String getPeriodRemoval() {
            return periodRemoval;
        }

        public void setPeriodRemoval(String periodRemoval) {
