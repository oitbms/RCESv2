...
public class AuthorControlDeviationServiceImpl implements AuthorControlDeviationService {
    ...
    public AuthorControlDeviationDto getDeviation(Long id) {
        ...
        AuthorControlDeviation authorControlDeviation = authorControlDeviationRepository.findById(id).orElseThrow(() -> new EntityNotFoundExceptionBormash("Deviation not found", NotificationType.ERROR));
